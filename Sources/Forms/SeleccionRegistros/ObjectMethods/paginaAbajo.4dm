  // SeleccionRegistros.paginaAbajo()
  // Por: Alberto Bachler: 12/11/13, 16:59:25
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
If ($l_registroSeleccionado>Records in selection:C76($y_tabla->))
	$l_registroSeleccionado:=Records in selection:C76($y_tabla->)
End if 
