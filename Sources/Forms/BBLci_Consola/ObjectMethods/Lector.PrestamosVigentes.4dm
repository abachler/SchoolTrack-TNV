  // BBLci_Consola.infoLector_PrestamosVigentes()
  // Por: Alberto Bachler: 25/10/13, 20:48:43
  //  ---------------------------------------------
  //
  //
  //  ---------------------------------------------
...
If ($b_botonActivo)
	...
	Case of 
		: (Form event:C388=On Clicked:K2:4)
			...
			$l_recNumPrestamo:=BBLci_InfoPrestamos (->[BBL_Prestamos:60];"ListaPrestamos_Lector")
			ModernUI_SetTextAttributes (OBJECT Get name:C1087(Object current:K67:2);Bold:K14:2;0;0;<>vl_ColorTextoBoton_Normal;<>vl_ColorFondoBoton)
