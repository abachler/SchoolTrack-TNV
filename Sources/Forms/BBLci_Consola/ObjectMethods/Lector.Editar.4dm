  // BBLci_Consola.Lector.Editar()
  // Por: Alberto Bachler K.: 29-01-14, 12:18:42
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
If (USR_checkRights ("M";->[BBL_Lectores:72]))
	Case of 
		: (Form event:C388=On Clicked:K2:4)
			...
			$y_tabla:=->[BBL_Lectores:72]
			$l_recNum:=Record number:C243([BBL_Lectores:72])
			$l_IdProceso:=New process:C317("BBLci_EditaLector";Pila_256K;"Lector en consola";$l_refModulo;$t_nombreModulo;$y_tabla;$l_recNum)
