			...
			Case of 
				: ($item=3)
					If ($line>0)
						...
						QUERY SELECTION:C341([xxACT_ItemsMatriz:180];[xxACT_ItemsMatriz:180]ID_Item:2=alACT_TerTRefItem{$line})
						$NoEnMatriz:=(Records in selection:C76([xxACT_ItemsMatriz:180])=0)
						$Especial:=ACTcar_EsCargoEspecial (alACT_TerTRefItem{$line})
