...
If ((Self:C308->>0) & (Self:C308-><=Size of array:C274($y_campos->)))
	Case of 
		: (Form event:C388=On Clicked:K2:4)
			Case of 
				: (Field:C253(Table:C252(->[ACT_Terceros:138]);$y_campos->{Self:C308->})=->[ACT_Terceros:138]Comuna:6)
					...
					If (Find in array:C230(<>aComuna;$y_valores->{Self:C308->})=-1)
						  //$y_valores->{Self->}:=<>aComuna{$l_existe}
			...
			Case of 
				: (Field:C253(Table:C252(->[ACT_Terceros:138]);$y_campos->{Self:C308->})=->[ACT_Terceros:138]Comuna:6)
					If (Find in array:C230(<>aComuna;$y_valores->{Self:C308->})=-1)
						...
						BEEP:C151
					End if 
				: (Field:C253(Table:C252(->[ACT_Terceros:138]);$y_campos->{Self:C308->})=->[ACT_Terceros:138]EMail:13)
