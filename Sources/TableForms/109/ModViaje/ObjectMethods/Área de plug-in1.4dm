Case of 
	: (alProEvt=AL Single click event)
		...
		IT_SetButtonState (($line>0);->bDelViajes)
	...
	: (alProEvt=AL Double click event)
		...
		$vIDViaje:=alBU_NumeroViaje{$line}
		$pos:=Find in array:C230(alIDRuta;[BU_Viajes:109]Numero_Ruta:3)
		QUERY:C277([BU_Viajes:109];[BU_Viajes:109]Fecha:2;=;dViaje;*)
		QUERY:C277([BU_Viajes:109]; & ;[BU_Viajes:109]Numero_Ruta:3;=;alIDRuta{$pos})
		...
		QUERY:C277([BU_Viajes_Personas:111];[BU_Viajes_Personas:111]Numero_Viaje:2;=;$vIDViaje;*)
		...
		ARRAY PICTURE:C279(ap_Asistencia;Size of array:C274(abBU_Asiste))
