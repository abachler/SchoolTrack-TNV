If (line>1)
	...
	Case of 
		: (vb_selectionItems2Pay)
			ACTit_MoveElementALP (ALP_CargosXPagar;1;->ap_item2Import;->at_glosasItems;->al_idItems;->ab_Item2Import;->alACT_idsRSOrg)
		...
		: (vb_selectionOrder2PayItems)
			ACTit_MoveElementALP (ALP_CargosXPagar;1;->at_glosasItems;->al_idItems;->ab_Item2Import;->alACT_idsRSOrg)
			  //$temp2:=at_glosasItems{line}
			  //$temp3:=al_idItems{line}
			  //$temp4:=ab_Item2Import{line}
			  //
