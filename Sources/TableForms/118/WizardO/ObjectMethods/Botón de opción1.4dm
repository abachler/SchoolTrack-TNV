If (Self:C308->=1)
	OBJECT SET TITLE:C194(PWTrf_Pac1;__ ("Archivo para importación de pagos"))
	OBJECT SET TITLE:C194(WTrf_ac2;__ ("Nuevo modelo de archivo para importación de pagos"))
	OBJECT SET TITLE:C194(WTrf_ac3;__ ("Modificar modelo de archivo para importación de pagos"))
End if 
