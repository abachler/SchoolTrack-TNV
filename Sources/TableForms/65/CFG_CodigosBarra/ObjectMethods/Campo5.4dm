  // [xxBBL_Preferencias].CFG_CodigosBarra.Campo2()
  // Por: Alberto Bachler: 06/09/13, 17:24:20
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
If (([xxBBL_Preferencias:65]Lector_BarCodeConPrefijo:35=False:C215) & ([xxBBL_Preferencias:65]Registro_BarCodeConPrefijo:32=False:C215))
	...
	OK:=CD_Dlog (0;$t_mensaje;"";"Utilizar prefijos";"Sin prefijos")
	If (OK=1)
		[xxBBL_Preferencias:65]Registro_BarCodeConPrefijo:32:=Old:C35([xxBBL_Preferencias:65]Registro_BarCodeConPrefijo:32)
