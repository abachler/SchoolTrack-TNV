...
If ($selected>0)
	...
	Case of 
		: ($parentItem=-1)
			GET LIST ITEM:C378(Self:C308->;$selected;$idEstilo;$nombreEstilo)
			[xxSTR_HistoricoNiveles:191]Id_EstiloEvaluacionOficial:9:=$idEstilo
	...
	LOG_RegisterEvt ("Cambio de estilo de evaluación oficial en registro histórico del nivel "+[xxSTR_HistoricoNiveles:191]NombreInterno:5+" para el año "+String:C10([xxSTR_HistoricoNiveles:191]Año:2))
End if 