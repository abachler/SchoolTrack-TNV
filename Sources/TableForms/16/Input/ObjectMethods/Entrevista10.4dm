If ((<>popIntLoc=5) & ([Alumnos_EventosPersonales:16]Solicitada_por:4#""))
	QUERY:C277([Profesores:4];[Profesores:4]Apellido_paterno:3=([Alumnos_EventosPersonales:16]Solicitada_por:4+"@"))
	Case of 
