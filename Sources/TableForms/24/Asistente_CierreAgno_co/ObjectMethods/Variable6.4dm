  // [xxSTR_DatosDeCierre].Asistente_CierreAgno_co.Variable6()
  // Por: Alberto Bachler K.: 04-10-14, 17:53:23
  //  ---------------------------------------------
  //
  //
  //  ---------------------------------------------
C_REAL:C285($r_libreVolumen;$r_tamañoBD;$r_tamañoVolumen;$r_usadoEnVolumen)
C_TEXT:C284($t_rutaRespaldos;$t_error;$t_separador)
...
Case of 
	...
	: (FORM Get current page:C276=3)
		If (Not:C34(vb_SituacionFinalOK))
			...
			QUERY SELECTION:C341([Alumnos:2]; | [Alumnos:2]Situacion_final:33="A")  //peru
			vi_alumnosPromovidos:=Records in selection:C76([Alumnos:2])
			USE SET:C118("Alumnos")
			QUERY SELECTION:C341([Alumnos:2];[Alumnos:2]Situacion_final:33="R";*)
			QUERY SELECTION:C341([Alumnos:2]; | [Alumnos:2]Situacion_final:33="D";*)  //peru
			QUERY SELECTION:C341([Alumnos:2]; | [Alumnos:2]Situacion_final:33="NP")  //colombia
