...
TBL_ShowChoiceList (0;"Seleccione el Centro de Costos";1;->vtACT_CCCCAFecha)
If (ok=1)
	If ((vtACT_CCCCAFecha#<>asACT_Centro{choiceIdx}) | (Windows Ctrl down:C562 | Macintosh command down:C546))
		vtACT_CCCCAFecha:=<>asACT_Centro{choiceIdx}
		...
		If (ok=1)
			If (r2=1)
				...
				AT_Populate (->asNCta;->vtACT_CCCCAFecha)
		...
		Else 
			vtACT_CCCCAFecha:=vtACT_CCCCAFechaCurrState
		End if 
	End if 
End if 