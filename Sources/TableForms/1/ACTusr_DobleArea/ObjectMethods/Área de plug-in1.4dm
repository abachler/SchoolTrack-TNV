Case of 
	...
	: (alProEvt=2)
		...
		$row:=AL_GetLine (Self:C308->)
		  //$vx_pointer:=aQR_Pointer1{$col}
		vQR_Pointer1:=aQR_Pointer1{$col}
		
		AL_UpdateArrays (Self:C308->;0)
		Case of 
			: (aQR_Text91{$col}="CuentaContable@")
				...
				If (ok=1)
					$vt_formato:=ST_GetWord (aQR_Text91{$col};2;";")
					$vl_largo:=Num:C11(ST_GetWord (aQR_Text91{$col};3;";"))
					$vt_relleno:=ST_GetWord (aQR_Text91{$col};4;";")
					$vt_align:=ST_GetWord (aQR_Text91{$col};5;";")
					  //If ($vt_relleno="")
			...
			Else 
				If (aQR_Text91{$col}#"")
					  //$vx_getPointer:=Get pointer(ST_GetWord (aQR_Text91{$col};1;";"))
					vQR_Pointer2:=Get pointer:C304(ST_GetWord (aQR_Text91{$col};1;";"))
