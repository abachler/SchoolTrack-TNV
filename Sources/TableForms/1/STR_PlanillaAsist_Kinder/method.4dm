...
If (Form event:C388=On Printing Detail:K2:18)
	  //TRACE
	$err:=PL_SetArraysNam (xPL_Matricula;1;3;"aMovimientos0";"aMovimientosk";"aMovimientosTK")
	...
	$err:=PL_SetArraysNam (xPL_Asistencia;1;3;"aAsistencia0";"aAsistenciak";"aAsistenciaTk")
