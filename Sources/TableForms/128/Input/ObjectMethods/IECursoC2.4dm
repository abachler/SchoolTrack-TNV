...
Case of 
	: (_O_During:C30)
		If ([Cursos_Eventos:128]ProfesorJefe_Nombre:8#"")
			QUERY:C277([Profesores:4];[Profesores:4]Apellido_paterno:3=([Cursos_Eventos:128]ProfesorJefe_Nombre:8+"@"))
			Case of 
				: (Records in selection:C76([Profesores:4])=0)
					...
					If ($r=1)
						...
						Else 
							[Cursos_Eventos:128]ProfesorJefe_Nombre:8:=""
							GOTO OBJECT:C206([Cursos_Eventos:128]ProfesorJefe_Nombre:8)
						End if 
				...
				: (Records in selection:C76([Profesores:4])>1)
					...
					If ((ok=1) & (choiceIdx>0))
						[Cursos_Eventos:128]ProfesorJefe_Nombre:8:=<>aChoicePtrs{1}->{choiceIdx}
					Else 
						[Cursos_Eventos:128]ProfesorJefe_Nombre:8:=""
						GOTO OBJECT:C206([Cursos_Eventos:128]ProfesorJefe_Nombre:8)
					End if 
