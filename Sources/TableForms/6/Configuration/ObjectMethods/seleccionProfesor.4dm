...
If ([xxSTR_Niveles:6]ID_DirectorNivel:52>0)
	$l_elemento:=Find in array:C230($al_IdProfesores;[xxSTR_Niveles:6]ID_DirectorNivel:52)
	If ($l_elemento>0)
...
Case of 
	...
	: ($l_itemSeleccionado>=3)
		...
		[xxSTR_Niveles:6]Director:13:=ST_ClearSpaces ([Profesores:4]Nombres:2+" "+[Profesores:4]Apellido_paterno:3+" "+[Profesores:4]Apellido_materno:4)
