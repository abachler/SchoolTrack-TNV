  // [BBL_Registros].Periodicals.Champ2()
  // Por: Alberto Bachler: 25/11/13, 22:16:46
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
Case of 
	...
	: (Form event:C388=On Data Change:K2:15)
		...
		$t_BarcodeSinFormato:=Replace string:C233([BBL_Registros:66]Código_de_barra:20;"*";"")
		...
		If (Not:C34($b_rechazarCambio))
			...
			[BBL_Registros:66]Código_de_barra:20:=$t_BarcodeSinFormato
