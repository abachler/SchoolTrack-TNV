  ...
  // Por: Alberto Bachler K.: 22-03-14, 11:37:11
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
		...
		Else 
			...
			Else 
				If (Old:C35([BBL_Registros:66]No_Registro:25)=0)
					...
					If ($l_registros>0)
						$t_mensaje:=__ ("Este número de registro ya ha sido utilizado para generar un código de barra para otro documento")+"\r\r"
						$t_mensaje:=$t_mensaje+__ ("Por favor asigne un numero de registro que permita generar un código de barra sin conflictos.")
