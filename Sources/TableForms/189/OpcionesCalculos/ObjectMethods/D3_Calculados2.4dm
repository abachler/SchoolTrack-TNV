If (Self:C308->=1)
	...
	Else 
		$t_mensaje:=__ ("No hay competencias en esta matriz.\r")
		$t_mensaje:=$t_mensaje+__ ("No es posible calcular el resultado sobre la base de las evaluaciones de las competencias.")
		CD_Dlog (0;$t_mensaje)
