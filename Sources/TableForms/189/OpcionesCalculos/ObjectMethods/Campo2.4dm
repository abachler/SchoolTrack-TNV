...
If (Self:C308->\
	...
	Case of 
		: ($ejes>\
			...
			If ([MPA_AsignaturasMatrices:189]BaseCalculoResultado:23=\
				0)\
				
				[MPA_AsignaturasMatrices:189]BaseCalculoResultado:23:=\
					Eje_Aprendizaje
				r1_ejes:=\
					1
			End if 
		...
		: ($competencias>\
			...
			End if 
	End case 
	IT_SetButtonState ($ejes>\
		0;\
		->\
		r1_Ejes)\
		
	IT_SetButtonState ($dimensiones>\
		0;\
		->\
		r2_Dimensiones)\
		
	IT_SetButtonState ($competencias>\
		0;\
		->\
		r3_competencias)\
		
	OBJECT SET ENTERABLE:C238([MPA_AsignaturasMatrices:189]Convertir_a_Notas:9;\
		True:C214)\
...
Else 
	...
	r3_Competencias:=\
		0
	[MPA_AsignaturasMatrices:189]Convertir_a_Notas:9:=\
		False:C215
