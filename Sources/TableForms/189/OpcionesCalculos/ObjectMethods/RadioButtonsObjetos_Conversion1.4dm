...
If (Self:C308->)
	  //$msg:="Si utiliza esta opción las eventuales notas existentes (en la modalidad de evalua"+"ción tradicional) en las asignaturas que utilizan esta matriz serán DEFINITIVAMEN"+"TE eliminadas y reemplazadas con las evaluaciones finales de los aprendizajes esp"+"erados."+"\r\r¿Está usted seguro de lo que está haciendo?"
