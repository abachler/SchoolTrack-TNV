Case of 
	: (Form event:C388=On Load:K2:1)
		...
		If (OB Is defined:C1231([Personas:7]OB_ACT_Direccion_Facturacion:117;"objeto_facturacion"))
			$ob_objetoPersona:=OB Get:C1224([Personas:7]OB_ACT_Direccion_Facturacion:117;"objeto_facturacion")
		...
		OB GET ARRAY:C1229($ob_direccion2;"apoderados";$y_campos->)
