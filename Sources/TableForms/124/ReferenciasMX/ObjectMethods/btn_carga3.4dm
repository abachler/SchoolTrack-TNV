If (Size of array:C274(alACT_idAviso)>0)
	...
	QUERY:C277([ACT_Pagos:172];[ACT_Pagos:172]Bancomer_referencia:35=vtACT_referencia)
	...
	If (Records in selection:C76([ACT_Pagos:172])>0)
		...
		ACCEPT:C269
	Else 
		CD_Dlog (0;"No hay Pagos asociados a la referencia: "+ST_Qte (vtACT_referencia)+".")
	End if 
End if 