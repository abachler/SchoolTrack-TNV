...
If ($valor=True:C214)
	...
	If ([ADT_Candidatos:49]Fecha_de_presentación:5=!00-00-00!)
		CD_Dlog (1;__ ("Debe asignar una fecha de presentación para poder noificarla."))
	Else 
		$r:=CD_Dlog (0;__ ("Confirma el envío de la notificación para la presentación?.");__ ("");__ ("Si");__ ("No"))
		If ($r=1)  //confirma
			ALERT:C41("Confirma")
		Else 
