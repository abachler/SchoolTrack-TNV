...
Else 
	...
	$loaded:=KRL_GotoRecord (->[Personas:7];viPST_MotherRecNum;True:C214)
	If ($loaded)
		...
		$studentRelateds:=Records in selection:C76([Alumnos:2])
		  ...
		  //verifiyng that the mother is not the mother of an other family
		...
		Case of 
			: (($familyRelateds=0) & ($studentRelateds=0) & ($otherRelations=0) & ($vl_records=0) & ($vl_records2=0))
				  //the mother is related only to this student and this family, it can be deleted   
			...
			: (($familyRelateds>0) | ($studentRelateds>0) | ($otherRelations>0))
				  //the mother is related to other families and students, 
