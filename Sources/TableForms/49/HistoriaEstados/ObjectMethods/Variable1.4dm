...
If (resul=True:C214)
	...
	SELECTION TO ARRAY:C260([xxADT_LogCambioEstado:162]DTS:2;$aDTS;[xxADT_LogCambioEstado:162]ID_SitFinal_Nuevo:7;$aIDNew;[xxADT_LogCambioEstado:162]ID_SitFinal_Viejo:6;$aIDOld;[xxADT_LogCambioEstado:162]ID_Usuario:5;$aUser)
	...
	For ($i;1;Size of array:C274($aDTS))
		...
		If (($foundold=aOldNameStateSF{aOldNameStateSF}) & ($foundnew=aNewNameStateSF{aNewNameStateSF}))
			  //borrar el registro
			READ WRITE:C146([xxADT_LogCambioEstado:162])
			QUERY SELECTION:C341([xxADT_LogCambioEstado:162];[xxADT_LogCambioEstado:162]ID_SitFinal_Viejo:6=$aIDOld{$i};*)
			QUERY SELECTION:C341([xxADT_LogCambioEstado:162]; & ;[xxADT_LogCambioEstado:162]ID_SitFinal_Nuevo:7=$aIDNew{$i})
