...
$err:=AL_GetHeaders (xALP_Browser;atBWR_HeadersList;1)
...
End for 
AT_Delete (Size of array:C274(alBWR_HeadersRefs);1;->atBWR_HeadersList;->alBWR_HeadersRefs)
...
Case of 
	: (OK=1)
		If (Count list items:C380(hl_OrderDefinition)>0)
			...
			$SortStr:="AL_SetSort(xALP_Browser;"
		...
		PREF_Set (USR_GetUserID ;"OrdenamientoPanel#"+String:C10(vlBWR_SelectedTableRef);$SortStr)
...
End case 
  ...
  //$sort:=AL_ShowSortEd (xALP_Browser)
