...
IT_Clairvoyance (Self:C308;->atACTbol_TercerosNombres;"";True:C214)
...
Case of 
	...
	: (Form event:C388=On Losing Focus:K2:8)
		$l_pos:=Find in array:C230(atACTbol_TercerosNombres;Self:C308->)
		If ($l_pos=-1)
			BEEP:C151
			Self:C308->:=vsACT_OldNomApellido
			l_idTerSel:=l_idTerSelT
		Else 
			l_idTerSel:=alACTbol_TercerosIds{$l_pos}
		End if 
