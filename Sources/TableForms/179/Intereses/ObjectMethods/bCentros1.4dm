...
TBL_ShowChoiceList (0;"Seleccione el Centro de Costos";1;->vsACT_CCentroIntereses)
If (ok=1)
	If ((vsACT_CCentroIntereses#<>asACT_Centro{choiceIdx}) | (Macintosh command down:C546 | Windows Ctrl down:C562))
		vsACT_CCentroIntereses:=<>asACT_Centro{choiceIdx}
		vtMsg:="Usted modificó el código de centro de costo contra para los intereses."+"\r"+"Si lo desea puede aplicar el nuevo código a los intereses ya generados o bien uti"+"liz"+"ar este nuevo código sólo para los intereses que se generen de ahora en adelante."
		...
		If (ok=1)
			If (r2=1)
				...
				AT_Populate (->asNCta;->vsACT_CCentroIntereses)
				  //0xDev_AvoidTriggerExecution (True)
				ARRAY TO SELECTION:C261(asNCta;[ACT_Cargos:173]CCentro_de_costos:40)
