...
If (ok=1)
	Case of 
		...
		: (r2=1)
			C_LONGINT:C283($proc)
			$proc:=IT_UThermometer (1;0;"Aplicando cambio a cargos ya generados/emitidos no incluidos en documentos tribut"+"arios...")
			...
			APPLY TO SELECTION:C70([ACT_Cargos:173];[ACT_Cargos:173]No_Incluir_en_DocTrib:50:=Self:C308->)
