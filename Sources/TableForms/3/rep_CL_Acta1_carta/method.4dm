...
Else 
	If (Form event:C388=On Printing Detail:K2:18)
		...
		If (vi_PEStart>0)
			...
			vPTextoPE:=aTtl3{1}
			If (SYS_IsMacintosh )
				OBJECT MOVE:C664(*;"vPTextoPC";leftmarge+4;75;leftmarge+4+PCwidth+1;86;*)
				OBJECT MOVE:C664(*;"vPTextoPE";leftmarge+4+PCwidth;75;leftmarge+4+PCwidth+1+PEwidth;86;*)
				OBJECT MOVE:C664(*;"BorderTPC";leftmarge+4;75;leftmarge+4+PCwidth+1;86;*)
				OBJECT MOVE:C664(*;"BorderTPE";leftmarge+4+PCwidth;75;leftmarge+4+PCwidth+1+PEwidth;86;*)
			Else 
				OBJECT MOVE:C664(*;"vPTextoPC";leftmarge+4;75;leftmarge+4+PCwidth;85;*)
				OBJECT MOVE:C664(*;"vPTextoPE";leftmarge+4+PCwidth;75;leftmarge+4+PCwidth+PEwidth;85;*)
				OBJECT MOVE:C664(*;"BorderTPC";leftmarge+4;75;leftmarge+4+PCwidth;85;*)
				OBJECT MOVE:C664(*;"BorderTPE";leftmarge+4+PCwidth;75;leftmarge+4+PCwidth+PEwidth;85;*)
			End if 
		End if 
		...
		$widths{7}:=iComuna
		If (SYS_IsMacintosh )
			OBJECT MOVE:C664(*;"vPTexto1";3;85;6;85;*)
			OBJECT MOVE:C664(*;"vPTexto1";0;0;$widths{1}-1.25;$height)
			OBJECT MOVE:C664(*;"BorderT1";3;85;6;85;*)
			OBJECT MOVE:C664(*;"BorderT1";0;0;$widths{1}-1.25;$height)
