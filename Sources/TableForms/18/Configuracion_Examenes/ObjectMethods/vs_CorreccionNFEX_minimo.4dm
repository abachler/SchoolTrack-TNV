...
$b_calificacionValida:=EV2_validaCalificacion ($y_CalificacionLiteral->;$y_CalificacionLiteral;->vr_CorreccionNFEX_minimo)
iconversiontable:=$l_usarTablaConversion
$y_CalificacionLiteral->:=Choose:C955(vr_CorreccionNFEX_minimo>=vrNTA_MinimoEscalaReferencia;NTA_PercentValue2StringValue (vr_CorreccionNFEX_minimo);"")
