...
If (vtEVLG_VistaActual="Alumnos")
	If ((vbMPA_ConfiguracionesPropias) | (USR_IsGroupMember_by_GrpID (-15001;USR_GetUserID )))
		$result:=Pop up menu:C542("Editar Matrices...;-;"+"(Ver por: ;"+"!"+Char:C90(18)+" Alumnos; Aprendizajes";0)
	Else 
		$result:=Pop up menu:C542("(Editar Matrices...;-;"+"(Ver por: ;"+"!"+Char:C90(18)+" Alumnos; Aprendizajes";0)
	End if 
Else 
	If (vbMPA_ConfiguracionesPropias)
		$result:=Pop up menu:C542("Editar Matrices...;-;"+"(Ver por: ;"+" Alumnos;"+"!"+Char:C90(18)+" Aprendizajes";0)
	Else 
		$result:=Pop up menu:C542("(Editar Matrices...;-;"+"(Ver por: ;"+" Alumnos;"+"!"+Char:C90(18)+" Aprendizajes";0)
	End if 
	  //$result:=Pop up menu("Alumnos;"+"!"+Char(18)+"Aprendizajes")
End if 
Case of 
	: ($result=1)
		...
		COPY ARRAY:C226(alEVLG_TipoObjeto;$alEVLG_TipoObjeto)
