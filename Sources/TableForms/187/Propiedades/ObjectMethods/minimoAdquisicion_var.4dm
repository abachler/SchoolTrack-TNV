  // [MPA_DefinicionCompetencias].Propiedades.minimoAdquisicion_var()
  // Por: Alberto Bachler K.: 04-03-15, 08:05:49
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
C_REAL:C285($r_valorReal;$r_realIncial)
  //MONO TICKET 183148
If (([MPA_DefinicionCompetencias:187]TipoEvaluacion:12=3) & (iEvaluationMode#Simbolos))
	$y_minimo:=OBJECT Get pointer:C1124(Object named:K67:5;"minimoAdquisicion_var")
	$r_realIncial:=[MPA_DefinicionCompetencias:187]PctParaAprobacion:22
	$r_valorReal:=EV2_ValidaIngreso ($y_minimo->)
	[MPA_DefinicionCompetencias:187]PctParaAprobacion:22:=$r_valorReal
	
	If ($r_valorReal#$r_realIncial)
