  // [BBL_Préstamos].ListaPrestamos_Lector.imagen()
  // Por: Alberto Bachler: 24/10/13, 09:52:52
  //  ---------------------------------------------
  //
  //
  //  ---------------------------------------------
...
If ([BBL_Prestamos:60]Número_de_registro:1>0)
	...
	OBJECT SET TITLE:C194(*;"titulo";[BBL_Items:61]Primer_título:4)
	...
	Case of 
		...
		: (([BBL_Prestamos:60]Fecha_de_devolución:5=!00-00-00!) & ([BBL_Prestamos:60]Hasta:4<$d_fechaActual))
			...
			C_DATE:C307($d_hasta)
			  ...
			  // Modificado por: Alexis Bustamante (26-07-2017)
			  //TICKET 185310
