  // [xxSTR_EstilosEvaluacion].Configuration.escalaPuntos_Hasta()
  //
  //
  // creado por: Alberto Bachler Klein: 11-07-16, 12:02:36
  // -----------------------------------------------------------
...
Case of 
	: (Form event:C388=On Mouse Enter:K2:33)
		...
		$t_mensaje:=__ ("Valor máximo aceptado en la escala de puntos.")
		If ($l_evaluaciones>0)
