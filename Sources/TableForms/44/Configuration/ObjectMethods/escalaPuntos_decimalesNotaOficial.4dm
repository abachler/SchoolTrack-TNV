...
$maxDec:=4-$l
If ($dec>$maxDec)
	CD_Dlog (0;Replace string:C233(Replace string:C233(__ ("El número de decimales no puede ser superior a ^0 si el puntaje máximo se compone de ^1 cifra(s).");__ ("^0");String:C10($maxDec));__ ("^1");String:C10($l));__ ("");__ ("OK"))
	Self:C308->:=$maxDec
	GOTO OBJECT:C206(Self:C308->)
Else 
	$decimales:=iPointsDec
	$intervalo:=rPointsInterval
