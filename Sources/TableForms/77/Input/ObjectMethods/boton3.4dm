...
If (vApNme#"")
	Case of 
		: (Table:C252(yBWR_currentTable)=Table:C252(->[Alumnos:2]))
							...
							Case of 
								: (Records in selection:C76([ACT_CuentasCorrientes:175])=1)
									If (Not:C34(KRL_ReadWrite (->[ACT_CuentasCorrientes:175])))
										  //[Alumnos]Apoderado_Cuentas_Número:=[Familia_RelacionesFamiliares]ID_Persona
			...
			KRL_UnloadReadOnlyOnServer (->[Personas:7])  //20151022 ASM Ticket 151461 
