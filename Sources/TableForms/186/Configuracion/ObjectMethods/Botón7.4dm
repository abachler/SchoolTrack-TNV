OBJECT MOVE:C664(*;"P01_AreaEje_btn@";Self:C308->;0)
OBJECT MOVE:C664(*;"P01_AreaDim_Info@";Self:C308->;0)
...
$l_anchoColumnaDimension:=$l_anchoColumnaDimension-Self:C308->
AL_SetWidths (xALP_Dimensiones;2;1;$l_anchoColumnaDimension)




  // ajustes de la posición, visibilidad y tamaño de objetos asociados al área Ejes
...
End if 
  ...
  // ajustes de la visibilidad y tamaño de objetos asociados al área Dimensiones
OBJECT GET COORDINATES:C663(*;"P01_AreaDim_plg";$l_izquierdaArea;$l_arribaArea;$l_derechaArea;$l_abajoArea)
$l_anchoArea:=$l_derechaArea-$l_izquierdaArea+1

If ($l_anchoArea<3)
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_plg@";False:C215)
Else 
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_plg@";True:C214)
End if 

If ($l_anchoArea<72)
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_Info@";False:C215)
Else 
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_Info@";True:C214)
End if 

If ($l_anchoArea<110)
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_btn@";False:C215)
Else 
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_btn@";True:C214)
End if 



OBJECT GET COORDINATES:C663(*;"P01_AreaDim_Nombre";$l_izquierdaObjeto;$l_arribaObjeto;$l_derechaObjeto;$l_abajoObjeto)
$l_izquierdaObjeto:=$l_izquierdaArea+72
$l_derechaObjeto:=$l_derechaArea-50
If (($l_derechaObjeto-$l_izquierdaObjeto)>=10)
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_Nombre";True:C214)
	IT_SetNamedObjectRect ("P01_AreaDim_Nombre";$l_izquierdaObjeto;$l_arribaObjeto;$l_derechaObjeto;$l_abajoObjeto)
Else 
	OBJECT SET VISIBLE:C603(*;"P01_AreaDim_Nombre";False:C215)
End if 
