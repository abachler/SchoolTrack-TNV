...
WEB SERVICE CALL:C778(<>urlSchoolNet;<>soapActionSchoolNet;$method;<>nameSpaceSchoolNet;Web Service dynamic:K48:1)

ON ERR CALL:C155($methodCalledOnError)

If ($logError)
	If ((vtWS_ErrorNum#"") & (vtWS_ErrorString#""))
		SNT_LogAction ("Error";vtWS_ErrorString;Num:C11(vtWS_ErrorNum))
	End if 
End if 
