...
C_LONGINT:C283($arrayAnterior;$cuota;$i;$j;$vnumTransCUP;$fileCounter)
...
$folderPath:=ACTabc_CreaRutaCarpetas ("Archivos Bancarios"+Folder separator:K24:12+"CUP"+Folder separator:K24:12+$folderName+Folder separator:K24:12)
...
aMontosArrayPtrs{1}->{Size of array:C274(aMontosArrayPtrs{1}->)}:=$FieldPtr->
aFechasIniPtrs{1}->{Size of array:C274(aFechasIniPtrs{1}->)}:=String:C10(Year of:C25([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"0000")+String:C10(Month of:C24([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")+String:C10(Day of:C23([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")
$montoAnterior:=$FieldPtr->
$arrayAnterior:=1
NEXT RECORD:C51([ACT_Avisos_de_Cobranza:124])
While (Not:C34(End selection:C36([ACT_Avisos_de_Cobranza:124])))
	$cuota:=Selected record number:C246([ACT_Avisos_de_Cobranza:124])
	If ($FieldPtr->=$montoAnterior)
	...
	Else 
		...
		aMontosArrayPtrs{Size of array:C274(aMontosArrayPtrs)}->{Size of array:C274(aMontosArrayPtrs{Size of array:C274(aMontosArrayPtrs)}->)}:=$FieldPtr->
		aFechasIniPtrs{Size of array:C274(aFechasIniPtrs)}->{Size of array:C274(aFechasIniPtrs{Size of array:C274(aFechasIniPtrs)}->)}:=String:C10(Year of:C25([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"0000")+String:C10(Month of:C24([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")+String:C10(Day of:C23([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")
		$montoAnterior:=$FieldPtr->
	...
	While (Not:C34(End selection:C36([ACT_Avisos_de_Cobranza:124])))
		...
		Else 
			...
			Else 
				...
				aMontosArrayPtrs{$fileCounter}->{Size of array:C274(aMontosArrayPtrs{$fileCounter}->)}:=$FieldPtr->
				aFechasIniPtrs{$fileCounter}->{Size of array:C274(aFechasIniPtrs{$fileCounter}->)}:=String:C10(Year of:C25([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"0000")+String:C10(Month of:C24([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")+String:C10(Day of:C23([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5);"00")
			End if 
...
For ($i;1;Size of array:C274(aRNArrayPtrs))
	...
	For ($j;1;Size of array:C274(aRNArrayPtrs{$i}->))
		...
		$text:="005080"+Substring:C12([Personas:7]RUT:6+(" "*21);1;21)+(" "*9)+" "+(" "*60)+(" "*346)+ST_Uppercase (ST_RigthChars ("0000000000"+Substring:C12([Personas:7]RUT:6;1;Length:C16([Personas:7]RUT:6)-1);9))+Substring:C12([Personas:7]RUT:6;Length:C16([Personas:7]RUT:6))+ST_LeftChars ([Personas:7]Apellidos_y_nombres:30+(" "*60);60)+ST_LeftChars ([Personas:7]Direccion:14+(" "*58);58)
		$text:=$text+ST_LeftChars ([Personas:7]Comuna:16+(" "*20);20)+(" "*456)+ST_RigthChars ("0000"+String:C10(aCFArrayPtrs{$i}->{$j});4)+ST_RigthChars ("000"+String:C10(aCIArrayPtrs{$i}->{$j});3)+ST_RigthChars ("0000000000"+String:C10(aMontosArrayPtrs{$i}->{$j});10)+"0000"+"M"+"N"+aFechasIniPtrs{$i}->{$j}+(" "*14)
		$text:=$text+"\r"
...
End for 
$l_ProgressProcID:=IT_Progress (-1;$l_ProgressProcID)
vnumTransCUP:=String:C10($vnumTransCUP)
SET_ClearSets ("avisosAño";"delApdo")
For ($i;1;Size of array:C274(aRNArrayPtrs))
