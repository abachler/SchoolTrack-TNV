...
Case of 
	: ($1="Inicio")
		...
		GOTO RECORD:C242([Alumnos:2];vQR_long2)
		EV2_RegistrosDelAlumno ([Alumnos:2]numero:1;[Alumnos:2]nivel_numero:29;Num:C11(vAño))
		...
		QUERY SELECTION:C341([Alumnos_Calificaciones:208];[Asignaturas_Historico:84]EnInformesInternos:43=True:C214)
