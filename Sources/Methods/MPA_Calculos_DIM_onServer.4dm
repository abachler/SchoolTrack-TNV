//%attributes = {"executedOnServer":true}
  // MÉTODO: MPA_Calculos_DIM_onServer
  // ----------------------------------------------------
  // Usuario (OS): Alberto Bachler
  // Fecha de creación: 03/01/12, 19:25:05
  // ----------------------------------------------------
  // DESCRIPCIÓN
  //
  //
  // PARÁMETROS
  // MPA_Calculos_DIM_Server()
  // ----------------------------------------------------
C_BOOLEAN:C305($0)
C_LONGINT:C283($1)
C_LONGINT:C283($2)
...
If ($l_recNum=-1)
	...
	PERIODOS_Init 
Else 
	$b_promedioModificado:=MPA_Calculos_Dimension ($l_recNum;$l_periodo;$l_tipoEvaluacion;$l_IdEstiloEvaluacion;$r_escalaMinimo;$r_escalaMaximo)
End if 