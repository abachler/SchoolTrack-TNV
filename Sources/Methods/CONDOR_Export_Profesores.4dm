...
C_LONGINT:C283($vl_params;$vl_rnProfe;$vl_rnAlumno;$vl_rnPersona)
C_TEXT:C284($uuid)
...
Case of 
	...
	: ($vl_params=5)
		...
		If (Not:C34(Is nil pointer:C315($5)))
			CREATE SELECTION FROM ARRAY:C640([Profesores:4];$5->)
		Else 
			ALL RECORDS:C47([Profesores:4])
		End if 
	Else 
...
If ((Records in selection:C76([Profesores:4])>0) & $vb_go)
	$refXMLDoc:=CONDOR_ExportDataGenArchivo ("profesores";->$vt_FileName)
	
	ARRAY LONGINT:C221($recNums;0)
	LONGINT ARRAY FROM SELECTION:C647([Profesores:4];$recNums)
	...
	For ($indice;1;$size)
		$vb_go:=False:C215
		KRL_GotoRecord (->[Profesores:4];$recNums{$indice})
		If ([Profesores:4]RUT:27#"")
			$vl_rnPersona:=KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Profesores:4]RUT:27)
			If ($vl_rnPersona>No current record:K29:2)
				$uuid:=[Personas:7]Auto_UUID:36
			Else 
				$uuid:=[Profesores:4]Auto_UUID:41
			End if 
		Else 
			$uuid:=[Profesores:4]Auto_UUID:41
		End if 
		If (Find in array:C230($y_UUIDPersonasEnviadas->;$uuid)=-1)
			APPEND TO ARRAY:C911($y_UUIDPersonasEnviadas->;$uuid)
			$vb_go:=True:C214
		End if 
		If ($vb_go)
			...
			If ($vt_Name#"")
				...
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"activo";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Inactivo:62);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"nombres";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Nombres:2);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"appaterno";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Apellido_paterno:3);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"apmaterno";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Apellido_materno:4);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"pasaporte";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Pasaporte:60);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]RUT:27);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional_2";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]IDNacional_2:42);True:C214;False:C215)
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional_3";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]IDNacional_3:43);True:C214;False:C215)
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"fechanacimiento";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Fecha_de_nacimiento:6);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"fechamuerte";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Fecha_Deceso:71);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"nacionalidad";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Nacionalidad:7);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"estadocivil";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Estado_civil:18);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"sexo";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Sexo:5);False:C215;False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"religion";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Religion:73);True:C214;False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"observaciones";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Observaciones:32);True:C214;False:C215)  //AGREGADO JHB
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"exalumno";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Es_ExAlumno:68);False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"cargo";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Cargo:19);True:C214;False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"codigo_interno";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Codigo_interno:30);True:C214;False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"prefijo";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Prefijo:72);True:C214;False:C215)  //global_persona
				If ([Profesores:4]RUT:27#"")
					$vl_rnPersona:=KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Profesores:4]RUT:27)
					If ($vl_rnPersona>No current record:K29:2)
					...
					Else 
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"uuid_persona";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Auto_UUID:41);False:C215;False:C215)  //global_persona
					End if 
				Else 
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"uuid_persona";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Auto_UUID:41);False:C215;False:C215)
				End if 
				...
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"foto";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Fotografia:59);False:C215;False:C215)
				...
				If ([Profesores:4]Telefono_domicilio:24#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"numero";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Telefono_domicilio:24);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"domicilio";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Profesores:4]Celular:44#"")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"telefono")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"numero";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Celular:44);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"celular personal";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Profesores:4]RUT:27#"")
					If (KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Profesores:4]RUT:27)>No current record:K29:2)
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"telefono")
				...
				If ([Profesores:4]eMail_Personal:61#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"direccion";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]eMail_Personal:61);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"personal";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Profesores:4]eMail_profesional:38#"")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"email")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"direccion";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]eMail_profesional:38);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"laboral";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Profesores:4]RUT:27#"")
				...
				If ([Profesores:4]Dirección:8+[Profesores:4]Comuna:10+[Profesores:4]Codigo_postal:33+[Profesores:4]Sector_Domicilio:75#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"direccion";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Dirección:8);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"comuna";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Comuna:10);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"codigopostal";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Codigo_postal:33);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"sector";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Sector_Domicilio:75);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"region";True:C214;CONDOR_ExportDataTransformer (->[Profesores:4]Region_o_Estado:12);True:C214;False:C215)  //AGREGADO JHB
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"domicilio";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Profesores:4]RUT:27#"")
				...
				If ([Profesores:4]RUT:27#"")
					...
					If (KRL_FindAndLoadRecordByIndex (->[xShell_Users:47]NoEmployee:7;->[Profesores:4]Numero:1;False:C215)>No current record:K29:2)
						...
						SAX CLOSE XML ELEMENT:C854($refXMLDoc)
					End if 
					$vl_rnAlumno:=KRL_FindAndLoadRecordByIndex (->[Alumnos:2]RUT:5;->[Profesores:4]RUT:27)
					If ($vl_rnAlumno>No current record:K29:2)
						APPEND TO ARRAY:C911($y_RNAlumnosEnviados->;$vl_rnAlumno)
						...
						SAX CLOSE XML ELEMENT:C854($refXMLDoc)
						If (Not:C34(Is nil pointer:C315($y_RNFamiliasXEnviar)))
							$vl_rnFamilia:=Find in field:C653([Familia:78]Numero:1;[Alumnos:2]Familia_Número:24)
							If (($vl_rnFamilia>No current record:K29:2) & (Find in array:C230($y_RNFamiliasXEnviar->;$vl_rnFamilia)=-1))
								APPEND TO ARRAY:C911($y_RNFamiliasXEnviar->;$vl_rnFamilia)
							End if 
						End if 
					End if 
				End if 
			...
			End if 
		End if 
		$l_ProgressProcID:=IT_Progress (0;$l_ProgressProcID;$indice/$size;__ ("Exportando profesor ")+[Profesores:4]Apellidos_y_nombres:28+", "+String:C10($indice)+__ (" de ")+String:C10($size)+"...")
	End for 
