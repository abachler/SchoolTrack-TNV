//%attributes = {"executedOnServer":true}
  ...
  // creado por: Alberto Bachler Klein: 18-03-16, 19:09:53
  // -----------------------------------------------------------
...
Case of 
	...
	: ($l_memoriaDisponible<=8192)
		...
		$l_minimoCache:=1024
	Else 
		$l_porcentajeCache:=70
		$l_maximoCache:=$l_memoriaDisponible*($l_porcentajeCache/100)
		$l_minimoCache:=1024
End case 
Case of 
	: ($t_OS="Mac@")  // limito a 1000 MB por una limitación de 4D v15 con El Capitan
		$l_minimoCache:=256
		$l_maximoCache:=1000
	: (Not:C34(<>sys_is64bitOS_B))
		$l_maximoCache:=2048  // el máximo que 4D puede utilizar en OS 32 bits
End case 
