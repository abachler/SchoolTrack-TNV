...
While ($text#"")
	...
	aRUT{Size of array:C274(aRUT)}:=ST_DeleteCharsLeft (Substring:C12($text;4;10);"0")
	aDescCodigo{Size of array:C274(aDescCodigo)}:=ST_DeleteCharsLeft (Substring:C12($text;55);"0")
