//%attributes = {}
  // Método: ACTabc_ImportPATYaocalli2
  //----------------------------------------------
  // Usuario (OS): roberto
  // Fecha: 31-03-10, 15:29:23
  // ---------------------------------------------
  // Descripción: 
  // 
  // Parámetros:
...
While ($text#"")
	...
	aMonto{Size of array:C274(aMonto)}:=Num:C11(Substring:C12($text;26;9)+<>tXS_RS_DecimalSeparator+Substring:C12($text;35;2))
	aRUT{Size of array:C274(aRUT)}:=ST_DeleteCharsLeft (Substring:C12($text;43;6);"0")
	...
	$vt_referencia:=Substring:C12($text;43;12)
	...
	aDescCodigo{Size of array:C274(aDescCodigo)}:=Substring:C12($text;8;1)
	If (aDescCodigo{Size of array:C274(aDescCodigo)}="A")
	...
	$vl_noCuota:=Num:C11(Substring:C12($text;51;2))
	$vl_ciclo:=Num:C11(Substring:C12($text;53;2))
	...
	End if 
	$vlACT_concepto:=Num:C11(Substring:C12($text;49;2))
