...
While ($text#"")
	...
	aMonto{Size of array:C274(aMonto)}:=Num:C11(Substring:C12($text;28;6))
	aRUT{Size of array:C274(aRUT)}:=ST_DeleteCharsLeft (Substring:C12($text;13;9);"0")
	aDescCodigo{Size of array:C274(aDescCodigo)}:=ST_DeleteCharsLeft (Substring:C12($text;34;2);"0")
