...
$t_formatoAUsar:="1"
$t_formatoAUsar:=PREF_fGet (0;"ACT_FormatoLibroCompraSoftland";$t_formatoAUsar)
...
If ($t_formatoAUsar="1")
	  //20150910 RCH Segundo formato que nos enviaron desde el San José de Chicureo. Está en el ticket 148895
	...
	While ($text#"")
		...
		If ($l_find>0)
			...
			APPEND TO ARRAY:C911(atACTie_COLUMNA20;ST_GetWord ($text;13;"\t"))  //Monto Total
			...
			If (Num:C11(atACTie_COLUMNA14{Size of array:C274(atACTie_COLUMNA14)})>0)
				...
				APPEND TO ARRAY:C911(atACTie_COLUMNA27;ST_GetWord ($text;11;"\t"))  //monto iva no recuperable
			Else 
...
Else 
	  ...
	  //20150910 RCH primer formato que nos enviaron desde el San José de Chicureo. Está en el ticket 148895
	While ($text#"")
		APPEND TO ARRAY:C911(atACTie_COLUMNA1;ST_GetWord ($text;1;";"))  //Tipo Documento
		APPEND TO ARRAY:C911(atACTie_COLUMNA2;"")  //Excepción Emisor
		APPEND TO ARRAY:C911(atACTie_COLUMNA3;ST_GetWord ($text;2;";"))  //Folio
		APPEND TO ARRAY:C911(atACTie_COLUMNA4;ST_GetWord ($text;8;";"))  //Anulado
		APPEND TO ARRAY:C911(atACTie_COLUMNA5;"1")  //operación
		APPEND TO ARRAY:C911(atACTie_COLUMNA6;ST_GetWord ($text;6;";"))  //Tipo Impuesto
		APPEND TO ARRAY:C911(atACTie_COLUMNA7;ST_GetWord ($text;4;";"))  //Tasa del Impuesto
		APPEND TO ARRAY:C911(atACTie_COLUMNA8;ST_GetWord ($text;27;";"))  //Número Interno
		APPEND TO ARRAY:C911(atACTie_COLUMNA9;ST_GetWord ($text;7;";"))  //Fecha Documento
		APPEND TO ARRAY:C911(atACTie_COLUMNA10;ST_GetWord ($text;26;";"))  //Código Sucursal
		  //APPEND TO ARRAY(atACTie_COLUMNA11;ST_GetWord ($text;3;";"))  //RUT Proveedor
		APPEND TO ARRAY:C911(atACTie_COLUMNA11;ST_Uppercase (ST_GetWord ($text;3;";")))  //RUT Proveedor //20160123 RCH
		APPEND TO ARRAY:C911(atACTie_COLUMNA12;ST_GetWord ($text;5;";"))  //Razón Social
		APPEND TO ARRAY:C911(atACTie_COLUMNA13;ST_GetWord ($text;9;";"))  //Monto Exento
		APPEND TO ARRAY:C911(atACTie_COLUMNA14;ST_GetWord ($text;10;";"))  //Monto Neto
		APPEND TO ARRAY:C911(atACTie_COLUMNA15;"0"+ST_GetWord ($text;11;";")+".00")  //Monto IVA
		APPEND TO ARRAY:C911(atACTie_COLUMNA16;ST_GetWord ($text;19;";"))  //Monto Neto Activo Fijo
		APPEND TO ARRAY:C911(atACTie_COLUMNA17;ST_GetWord ($text;20;";"))  //IVA Activo Fijo
		APPEND TO ARRAY:C911(atACTie_COLUMNA18;ST_GetWord ($text;14;";"))  //IVA Uso Común
		APPEND TO ARRAY:C911(atACTie_COLUMNA19;ST_GetWord ($text;18;";"))  //Impuesto Sin derecho a crédito
		APPEND TO ARRAY:C911(atACTie_COLUMNA20;ST_GetWord ($text;29;";"))  //Monto Total
		APPEND TO ARRAY:C911(atACTie_COLUMNA21;ST_GetWord ($text;21;";"))  //IVA No Retenido
		APPEND TO ARRAY:C911(atACTie_COLUMNA22;ST_GetWord ($text;22;";"))  //Tabaco Puros
		APPEND TO ARRAY:C911(atACTie_COLUMNA23;ST_GetWord ($text;23;";"))  //Tabaco Cigarrillos
		APPEND TO ARRAY:C911(atACTie_COLUMNA24;ST_GetWord ($text;24;";"))  //Tabaco Elaborado
		APPEND TO ARRAY:C911(atACTie_COLUMNA25;ST_GetWord ($text;25;";"))  //Impuesto Vehículo
		
		APPEND TO ARRAY:C911(atACTie_COLUMNA26;ST_GetWord ($text;12;";"))  //Cod iva no recuperable
		APPEND TO ARRAY:C911(atACTie_COLUMNA27;ST_GetWord ($text;13;";"))  //monto iva no recuperable
