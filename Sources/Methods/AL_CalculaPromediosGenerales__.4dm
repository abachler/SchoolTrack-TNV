			...
			Else 
				...
				If ($l_evaluaciones>0)
					...
					CREATE SET:C116([Alumnos_Calificaciones:208];"Calificaciones")
					  ...
					  //20110906 RCH Se calculaban algunas variables del promedio interno del periodo 1 con el estilo de evaluacion oficial
					...
					If (Records in selection:C76([Alumnos_Calificaciones:208])>0)
						...
						SET AUTOMATIC RELATIONS:C310(False:C215;False:C215)
						  ...
						  //EVS_ReadStyleData ($al_idEstiloEvaluacion{1}
						  //$r_notasDesde:=rGradesFrom
						  //$r_notasHasta:=rGradesTo
						  //$r_puntosDesde:=rPointsFrom
						  //$r_puntosHasta:=rPointsTo
						  //For ($i;1;Size of array($al_idEstiloEvaluacion))
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal1  //Choose($l_modoImpresionOficial-1;->$aNota1;->$aPuntos1;->$aReal1;->$aReal1)
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal2  //Choose($l_modoImpresionOficial-1;->$aNota2;->$aPuntos2;->$aReal2;->$aReal2)
							AL_RetornaPromedios ($l_estiloEvaluacionInterno;$l_modoImpresionInterno;$l_modoPromedioInterno;"PP";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal3  //Choose($l_modoImpresionOficial-1;->$aNota3;->$aPuntos3;->$aReal3;->$aReal3)
							AL_RetornaPromedios ($l_estiloEvaluacionInterno;$l_modoImpresionInterno;$l_modoPromedioInterno;"PP";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal4  //Choose($l_modoImpresionOficial-1;->$aNota4;->$aPuntos4;->$aReal4;->$aReal4)
							AL_RetornaPromedios ($l_estiloEvaluacionInterno;$l_modoImpresionInterno;$l_modoPromedioInterno;"PP";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal5  //Choose($l_modoImpresionOficial-1;->$aNota5;->$aPuntos5;->$aReal5;->$aReal5)
							AL_RetornaPromedios ($l_estiloEvaluacionInterno;$l_modoImpresionInterno;$l_modoPromedioInterno;"PP";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						If ($b_hayNotas)
							$y_reales:=->$aRealAnual  //Choose($l_modoImpresionInterno-1;->$aRealAnualNotas;->$aRealAnualPuntos;->$aRealAnual;->$aRealAnual)
						...
						If ($b_hayNotas)
							  ...
							  //ABC187033
							ARRAY REAL:C219($ar_calculo;0)
							$y_reales:=->$aRealFinal  // Choose($l_modoImpresionOficial-1;->$aRealFinalNotas;->$aRealFinalPuntos;->$aRealFinal;->$aRealFinal)  //MONO TICKET 193431
							  // Calculo del promedio final interno NO aproximado
					...
					End if 
					  ...
					  //20110906 RCH Se calculaban algunas variables del promedio oficial del periodo 1 con la configuracion del estilo de evaluacion interno
					...
					If (Records in selection:C76([Alumnos_Calificaciones:208])>0)
						...
						If ($b_hayNotas)
							$y_reales:=->$aReal1  //Choose($l_modoImpresionOficial-1;->$aNota1;->$aPuntos1;->$aReal1;->$aReal1)
							AL_RetornaPromedios ($l_estiloEvaluacionOficial;$l_modoImpresionOficial;$l_modoPromedioOficial;"PP";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						$b_hayNotas:=(AT_SearchArray (->$aRealAnual;">=")>0)
						If ($b_hayNotas)
							$y_reales:=->$aRealAnual  //Choose($l_modoImpresionOficial-1;->$aRealAnualNotas;->$aRealAnualPuntos;->$aRealAnual;->$aRealAnual)
							AL_RetornaPromedios ($l_estiloEvaluacionOficial;$l_modoImpresionOficial;$l_modoPromedioOficial;"PF";$l_truncarPromedios;$y_reales;$y_Arreglofactores;->$r_mediaReal;->$r_MediaNota;->$r_MediaPuntos;->$t_MediaLiteral;->$t_MediaSimbolos;->$al_idEstiloEvaluacion)
						...
						If ($b_hayNotas)
							  ...
							  //Se Copia arreglo ya que este es setiado en AL_retorna promeido con un estilo de evaluacion.
							  //ABC187033
							ARRAY REAL:C219($ar_calculo;0)
							$y_reales:=->$aRealOficial  //Choose($l_modoImpresionOficial-1;->$aRealNotasOficial;->$aRealPuntosOficial;->$aRealOficial;->$aRealOficial)
							  //COPY ARRAY($y_reales->;$ar_calculo)
