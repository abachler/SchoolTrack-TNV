...
For ($i;1;Size of array:C274(aidsAvisos))
	...
	If ($linea=-1)
		AT_Insert (1;1;->aMonto;->aNumTarjeta;->aNombre;->aRUT;->aRUT2;->aidsPersonas)
...
For ($i;1;Size of array:C274(aIndicador))
	$line:=String:C10(aMonto{$i})+";"+aNumTarjeta{$i}+";"+aNombre{$i}+";"+aRUT{$i}+";"+aRUT2{$i}+"\r"
...
AT_Initialize (->aMonto;->aNumTarjeta;->aNombre;->aRUT;->aRUT2;->aidsPersonas;->aidsAvisos)