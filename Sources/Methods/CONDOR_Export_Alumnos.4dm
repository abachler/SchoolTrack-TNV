...
Case of 
	...
	: ($vl_params=5)
		...
		If (Not:C34(Is nil pointer:C315($5)))
			CREATE SELECTION FROM ARRAY:C640([Alumnos:2];$5->)
		Else 
			ALL RECORDS:C47([Alumnos:2])
		End if 
	Else 
...
If ((Records in selection:C76([Alumnos:2])>0) & $vb_go)
	$refXMLDoc:=CONDOR_ExportDataGenArchivo ("alumnos";->$vt_FileName)
	
	ARRAY LONGINT:C221($recNums;0)
	LONGINT ARRAY FROM SELECTION:C647([Alumnos:2];$recNums)
	...
	For ($indice;1;$size)
		$vb_go:=False:C215
		KRL_GotoRecord (->[Alumnos:2];$recNums{$indice})
		If ([Alumnos:2]RUT:5#"")
			$vl_rnPersona:=KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Alumnos:2]RUT:5)
			If ($vl_rnPersona>No current record:K29:2)
				$uuid:=[Personas:7]Auto_UUID:36
			Else 
				$vl_rnProfe:=KRL_FindAndLoadRecordByIndex (->[Profesores:4]RUT:27;->[Alumnos:2]RUT:5)
				If ($vl_rnProfe>No current record:K29:2)
					$uuid:=[Profesores:4]Auto_UUID:41
				Else 
					$uuid:=[Alumnos:2]auto_uuid:72
				End if 
			End if 
		Else 
			$uuid:=[Alumnos:2]auto_uuid:72
		...
		If ($vb_go)
			...
			If ($vt_Name#"")
				...
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"activo";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Status:50);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"nombres";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Nombres:2);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"appaterno";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Apellido_paterno:3);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"apmaterno";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Apellido_materno:4);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"pasaporte";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]NoPasaporte:87);True:C214;False:C215)  //AGREGAR JHB
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]RUT:5);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional_2";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]IDNacional_2:71);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"idnacional_3";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]IDNacional_3:70);True:C214;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"fechanacimiento";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Fecha_de_nacimiento:7);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"fechamuerte";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Fecha_Deceso:98);False:C215;False:C215)  //usuario
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"nacionalidad";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Nacionalidad:8);True:C214;False:C215)  //usuario
				If ([Alumnos:2]RUT:5#"")
					If (KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Alumnos:2]RUT:5)>No current record:K29:2)
					...
					Else 
						If (KRL_FindAndLoadRecordByIndex (->[Profesores:4]RUT:27;->[Alumnos:2]RUT:5)>No current record:K29:2)
					...
					End if 
				End if 
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"sexo";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Sexo:49);False:C215;False:C215)  //global_persona
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"religion";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Religion:9);True:C214;False:C215)  //global_persona
				If ([Alumnos:2]RUT:5#"")
					If (KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Alumnos:2]RUT:5)>No current record:K29:2)
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"nivel_estudios";True:C214;CONDOR_ExportDataTransformer (->[Personas:7]Nivel_de_estudios:11);True:C214;False:C215)  //usuario
					End if 
				End if 
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"observaciones";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Observaciones_generales:39);True:C214;False:C215)
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"exalumno";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Es_ExAlumno:90);False:C215)  //global_persona
				If ([Alumnos:2]RUT:5#"")
					If (KRL_FindAndLoadRecordByIndex (->[Personas:7]RUT:6;->[Alumnos:2]RUT:5)>No current record:K29:2)
				...
				If ([Alumnos:2]RUT:5#"")
					...
					Else 
						...
						Else 
							CONDOR_ExportSAXCreateNode ($refXMLDoc;"codigo_interno";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Codigo_interno:6);True:C214;False:C215)  //global_persona
							CONDOR_ExportSAXCreateNode ($refXMLDoc;"uuid_persona";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]auto_uuid:72);False:C215;False:C215)  //global_persona
						End if 
					End if 
				Else 
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"codigo_interno";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Codigo_interno:6);True:C214;False:C215)  //global_persona
				...
				CONDOR_ExportSAXCreateNode ($refXMLDoc;"foto";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Fotografía:78);False:C215;False:C215)
				If ([Alumnos:2]RUT:5#"")
					If (KRL_FindAndLoadRecordByIndex (->[Profesores:4]RUT:27;->[Alumnos:2]RUT:5)>No current record:K29:2)
				...
				If ([Alumnos:2]Telefono:17#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"numero";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Telefono:17);True:C214;False:C215)
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipo";True:C214;"domicilio";False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
				End if 
				If ([Alumnos:2]Celular:95#"")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"telefono")
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"numero";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]Celular:95);True:C214;False:C215)
				...
				If ([Alumnos:2]eMAIL:68#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"direccion";True:C214;CONDOR_ExportDataTransformer (->[Alumnos:2]eMAIL:68);True:C214;False:C215)
			...
			End if 
		End if 
		$l_ProgressProcID:=IT_Progress (0;$l_ProgressProcID;$indice/$size;__ ("Exportando alumno ")+[Alumnos:2]apellidos_y_nombres:40+", "+String:C10($indice)+__ (" de ")+String:C10($size)+"...")
	End for 
