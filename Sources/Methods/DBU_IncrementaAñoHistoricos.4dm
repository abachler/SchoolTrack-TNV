//%attributes = {}
  // MÉTODO: DBU_IncrementaAñoHistoricos
  // ----------------------------------------------------
  // Usuario (OS): Alberto Bachler
  // Fecha de creación: 12/01/12, 12:21:08
  // ----------------------------------------------------
  // DESCRIPCIÓN
  // 
  //
  ...
  // ----------------------------------------------------
_O_C_INTEGER:C282($i_año)
C_LONGINT:C283($i;$l_desdeAño;$l_hastaAño;$newYear;$oldYear)
...
If (Count parameters:C259=2)
	...
	OK:=1
Else 
	$t_mensaje:="Este método incrementa (+1) el número del año en historicos\r"
...
If (OK=1)
	Case of 
		: (($l_hastaAño=0) | ($l_desdeAño=0))
			CD_Dlog (0;"Los años mas reciente o más antiguos no fueron especificados correctamente. \r\rIncrementación abortada.")
			OK:=0
			
		: (($l_hastaAño+1)>=<>gYear)
			CD_Dlog (0;"El año histórico mas reciente se sobrepondría al año actual. \r\rIncrementación abortada.")
			OK:=0
			
		: ($l_hastaAño<$l_desdeAño)
			CD_Dlog (0;"El año mas reciente especificado es inferior al año mas antiguo. \r\rIncrementación abortada.")
			OK:=0
		Else 
			OK:=1
	End case 
...
If (OK=1)
	...
	For ($i_año;$l_hastaAño;$l_desdeAño;-1)
		$oldYear:=$i_año
		$newYear:=$oldYear+1
		...
		For ($i;1;Size of array:C274(aQR_longint1))
			...
			$l_idCruso:=Abs:C99([Cursos_SintesisAnual:63]ID_Curso:52)  //MONO 184433
			[Cursos_SintesisAnual:63]LLavePrimaria:6:=KRL_MakeStringAccesKey (->[Cursos_SintesisAnual:63]ID_Institucion:1;->[Cursos_SintesisAnual:63]Año:2;->[Cursos_SintesisAnual:63]NumeroNivel:3;->[Cursos_SintesisAnual:63]Curso:5;->$l_idCruso)  //MONO 184433
