...
$root:=DOM Create XML Ref:C861("FECompTotXRequest";$nameSpace)

$subElem:=DOM Create XML element:C865($root;"/FECompTotXRequest/Auth/Token")
DOM SET XML ELEMENT VALUE:C868($subElem;$1)

$subElem:=DOM Create XML element:C865($root;"/FECompTotXRequest/Auth/Sign")
DOM SET XML ELEMENT VALUE:C868($subElem;$2)

$subElem:=DOM Create XML element:C865($root;"/FECompTotXRequest/Auth/Cuit")
...
WEB SERVICE CALL:C778("https://wswhomo.afip.gov.ar/wsfev1/service.asmx";"http://ar.gov.afip.dif.FEV1/FECompTotXRequest";"FECompTotXRequest";"http://ar.gov.afip.dif.FEV1/";Web Service manual:K48:4)
...
If (OK=1)
	...
	$resSubElem:=DOM Find XML element:C864($resRoot;"/FECompTotXRequestResponse/FECompTotXRequestResult/Errors")
	...
	If (Size of array:C274($at_errores)=0)
		...
		$resSubElem:=DOM Find XML element:C864($resRoot;"/FECompTotXRequestResponse/FECompTotXRequestResult/RegXReq")
		DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret1)
		
		  //Verifica Eventos
		C_TEXT:C284($t_evento)
		ARRAY TEXT:C222($at_eventos;0)
		$resSubElem:=DOM Find XML element:C864($resRoot;"/FECompTotXRequestResponse/FECompTotXRequestResult/Events")
		If ($resSubElem#"0000000000000000")
