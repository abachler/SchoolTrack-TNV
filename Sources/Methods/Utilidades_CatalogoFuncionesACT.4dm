//%attributes = {}
  ...
  // ----------------------------------------------------
  // Método: Utilidades_CatalogoFuncionesACT
  // Descripción
  // Para recopilar código que sirva para ser usado desde informes para el módulo ACT. La idea es poder copiar pegar el código o llamar al caso para que ejecute cierto código
  //
  // Parámetros
