...
C_LONGINT:C283($correlativo;$noCuotas)
...
$vt_nomEmpresa:="Instituto Alemán de Osorno"
$vt_ctaCteEmpresa:="61050555"

$text:="1"+ST_LeftChars ($vt_nomEmpresa+(" "*37);37)+ST_RigthChars (("0"*8)+$vt_ctaCteEmpresa;8)+"10"+"0"+ST_RigthChars (("0"*9)+String:C10($MontoApo);9)+"000"+ST_RigthChars (("0"*2)+String:C10(Month of:C24([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5));2)+Substring:C12(String:C10(Year of:C25([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5));3;2)+"01"+ST_RigthChars (("0"*2)+String:C10(Day of:C23([ACT_Avisos_de_Cobranza:124]Fecha_Vencimiento:5));2)+ST_RigthChars (("0"*11)+String:C10(9000+1);11)+"\r"
...
While (Not:C34(End selection:C36([ACT_Avisos_de_Cobranza:124])))
	...
	If (Records in selection:C76([ACT_Avisos_de_Cobranza:124])>0)
		...
		For ($i;1;$noCuotas)
			...
			$text:="2"+ST_RigthChars (("0"*11)+[Alumnos:2]numero_de_matricula:51;11)+ST_LeftChars ([Personas:7]Apellidos_y_nombres:30+(" "*20);20)+ST_RigthChars (("0"*9)+String:C10($MontoApo);9)+"000"+ST_RigthChars (("0"*3)+String:C10($i);3)+ST_RigthChars (("0"*11)+String:C10(9000+$correlativo);11)+$fecha+"01"+("0"*14)+"\r"
			IO_SendPacket ($ref;$text)
			$vl_mes:=$vl_mes+1
			If ($vl_mes=13)
				$vl_mes:=1
