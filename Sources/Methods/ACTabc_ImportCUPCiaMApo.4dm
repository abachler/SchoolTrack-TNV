...
While ($text#"")
	...
	aMonto{Size of array:C274(aMonto)}:=Int:C8(Num:C11(ST_GetWord ($text;6;";"))/10000)
	aRUT{Size of array:C274(aRUT)}:=ST_DeleteCharsLeft (ST_GetWord ($text;14;";");"0")
	...
	aMontoMora{Size of array:C274(aMontoMora)}:=Int:C8(Num:C11(ST_GetWord ($text;8;";"))/10000)
	RECEIVE PACKET:C104($ref;$text;$delimiter)
	$text:=_O_Win to Mac:C464($text)
End while 
