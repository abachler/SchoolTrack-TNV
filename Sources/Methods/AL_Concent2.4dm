//%attributes = {}
  // AL_Concent2()
  // Por: Alberto Bachler K.: 28-02-14, 16:12:08
  //  ---------------------------------------------
  //
  //
  //  ---------------------------------------------
...
Case of 
	...
	Else 
		...
		iYear2:=[Alumnos_SintesisAnual:210]Año:2
...
If (iYear2>0)
	...
	$t_llaveRegistro:=String:C10(<>ginstitucion)+"."+String:C10(iYear2)+".10."+String:C10([Alumnos:2]numero:1)
	...
	vAsist2:=[Alumnos_SintesisAnual:210]PorcentajeAsistencia:33
	vFinal2:=[Alumnos_SintesisAnual:210]PromedioFinalOficial_Literal:29
	...
	Case of 
		: (vi_DecAsistencia=0)
			vAsist2:=Round:C94(vAsist2;0)
		: (vi_DecAsistencia=1)
			vAsist2:=Round:C94(vAsist2;1)
		: (vi_DecAsistencia=2)
			vAsist2:=Round:C94(vAsist2;2)
	End case 
	
	SET AUTOMATIC RELATIONS:C310(True:C214;False:C215)
	EV2_RegistrosDelAlumno ([Alumnos:2]numero:1;[Alumnos_SintesisAnual:210]NumeroNivel:6;iYear2)
	
	If ([Alumnos_Historico:25]Colegio_anterior:20#"")
		sSchool2:=[Alumnos_Historico:25]Colegio_anterior:20
	Else 
		sSchool2:=sAltSchool2
	End if 
	
	If ([Alumnos_Historico:25]Ciudad_ColegioAnterior:25#"")
		sCity2:=[Alumnos_Historico:25]Ciudad_ColegioAnterior:25
	Else 
		sCity2:=sAltCity2
	End if 
	
	If ([Alumnos_Historico:25]DPE_ColegioAnterior:26#"")
		sCoop2:=[Alumnos_Historico:25]DPE_ColegioAnterior:26
	Else 
		sCoop2:=sAltCoop2
	End if 
	
	If ([Alumnos_Historico:25]DEyP_ColegioAnterior:27#"")
		sPLan2:=[Alumnos_Historico:25]DEyP_ColegioAnterior:27
	Else 
		sPLan2:=sAltPlan2
	End if 
	...
	For ($i_asignatura;1;Size of array:C274($at_asignaturas))
		If ($ab_incluidaEnActas{$i_asignatura})
			  //$at_notaLiteral{$i_asignatura}:=Replace string($at_notaLiteral{$i_asignatura};".";",")
