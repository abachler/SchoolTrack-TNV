...
While ($text#"")
	...
	aRUT{Size of array:C274(aRUT)}:=Replace string:C233(ST_GetCleanString (ST_GetWord ($text;10;";"));"-";"")
	aCodAprobacion{Size of array:C274(aCodAprobacion)}:=ST_GetCleanString (ST_GetWord ($text;13;";"))
	aDescCodigo{Size of array:C274(aDescCodigo)}:=ST_CleanString (ST_GetWord ($text;18;";"))
	RECEIVE PACKET:C104($ref;$text;$delimiter)
	$text:=_O_Win to Mac:C464($text)
End while 
