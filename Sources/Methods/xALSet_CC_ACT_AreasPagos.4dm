...
$Error:=AL_SetArraysNam (xALP_Pagos;1;1;"aACT_CtasPIDPagos")
$Error:=AL_SetArraysNam (xALP_Pagos;2;1;"aACT_CtasPFecha")
$Error:=AL_SetArraysNam (xALP_Pagos;3;1;"aACT_CtasPGlosa")
$Error:=AL_SetArraysNam (xALP_Pagos;4;1;"aACT_CtasPMonto")
$Error:=AL_SetArraysNam (xALP_Pagos;5;1;"aACT_CtasPSaldo")
$Error:=AL_SetArraysNam (xALP_Pagos;6;1;"aACT_CtasPNulo")
...
C_LONGINT:C283($Error)
  ...
  //specify arrays to display
$Error:=AL_SetArraysNam (xALP_DesglosePago;1;1;"aACT_CtasDPFecha")
$Error:=AL_SetArraysNam (xALP_DesglosePago;2;1;"aACT_CtasDPPeriodo")
$Error:=AL_SetArraysNam (xALP_DesglosePago;3;1;"aACT_CtasDPMonto")
$Error:=AL_SetArraysNam (xALP_DesglosePago;4;1;"aACT_CtasDPSaldoCargo")
$Error:=AL_SetArraysNam (xALP_DesglosePago;5;1;"aACT_CtasDPPagadoCargo")
$Error:=AL_SetArraysNam (xALP_DesglosePago;6;1;"aACT_CtasDPGlosaCargo")

  //column 1 settings
AL_SetHeaders (xALP_DesglosePago;1;1;"Fecha")
...
AL_SetEntryCtls (xALP_DesglosePago;1;0)
  ...
  //column 2 settings
AL_SetHeaders (xALP_DesglosePago;2;1;"Período")
...
AL_SetEntryCtls (xALP_DesglosePago;2;0)
  ...
  //column 3 settings
AL_SetHeaders (xALP_DesglosePago;3;1;"Monto")
AL_SetFormat (xALP_DesglosePago;3;"|Despliegue_ACT";0;2;0;0)
...
AL_SetEntryCtls (xALP_DesglosePago;3;0)
  ...
  //column 4 settings
AL_SetHeaders (xALP_DesglosePago;4;1;"Saldo Cargo")
...
AL_SetEntryCtls (xALP_DesglosePago;4;0)
  ...
  //column 5 settings
AL_SetHeaders (xALP_DesglosePago;5;1;"Pagado Cargo")
...
AL_SetEntryCtls (xALP_DesglosePago;5;0)
  ...
  //column 6 settings
AL_SetHeaders (xALP_DesglosePago;6;1;"Glosa Cargo")
AL_SetFormat (xALP_DesglosePago;6;"";0;2;0;0)
...
AL_SetWidths (xALP_DesglosePago;1;6;65;80;80;80;80;346)
