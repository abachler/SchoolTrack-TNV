//%attributes = {}
  // Método: MDATA_RetornaBooleano
  //----------------------------------------------
  // Usuario (OS): Alberto Bachler
  // Fecha: 26/10/09, 10:35:41
  // ---------------------------------------------
  // Descripción: 
  // 
  // Parámetros:
...
If (Records in selection:C76([xxSTR_MetadatosLocales:141])=1)
	...
	$0:=KRL_GetBooleanFieldData (->[MDATA_RegistrosDatosLocales:145]Llave:5;->$key;->[MDATA_RegistrosDatosLocales:145]Valor_Booleano:9)
End if 
