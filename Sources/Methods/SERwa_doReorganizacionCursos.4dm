...
$t_respuestas:=NV_GetValueFromPairedArrays ($y_Names;$y_Data;"respuestas")
If ($t_llave=XCRwa_GeneraLlave ($t_uuid1;$t_uuid2))
	...
	If (STWA2_Priv_GetMethodAccess ("CU_Reorganizacion";$idUser))
		...
		Else 
			...
			JSON PARSE ARRAY:C1219($t_respuestas;$at_respuestas)
			...
			End for 
			$0:=AL_Transfiere (->$a_alumnosids;$t_cursoOrigen;$t_cursoDestino;->$at_respuestas)
		End if 
	Else 
