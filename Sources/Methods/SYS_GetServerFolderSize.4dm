//%attributes = {"executedOnServer":true}
  // MÉTODO: SYS_GetServerFolderSize
  // ----------------------------------------------------
  // Usuario (OS): Alberto Bachler
  // Fecha de creación: 09/06/11, 11:01:15
  // ----------------------------------------------------
  // DESCRIPCIÓN
  // 
  //
...
Case of 
	: ((Test path name:C476($t_folderPath)=Is a folder:K24:2) | ((($t_folderPath="@.app") | ($t_folderPath="@.bundle")) & (SYS_IsMacintosh )))
