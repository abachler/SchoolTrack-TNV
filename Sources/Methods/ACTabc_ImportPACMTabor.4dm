...
While ($text#"")
	...
	aRUT{Size of array:C274(aRUT)}:=ST_ClearSpaces (Substring:C12($text;11;23))
	aDescCodigo{Size of array:C274(aDescCodigo)}:=Substring:C12($text;61;1)
	If (aDescCodigo{Size of array:C274(aDescCodigo)}="3")
