//%attributes = {}
  // XSstat_Anuales_out()
  // Por: Alberto Bachler: 29/04/13, 16:33:00
  //  ---------------------------------------------
  //
  //
  //  ---------------------------------------------
...
$t_DTS_inicioPeriodo:=String:C10($l_año;"0000")+"01010000"
$t_DTS_terminoPeriodo:=String:C10($l_año;"0000")+"12312359"
$l_TipoPeriodo:=3
$t_NombrePeriodo:=String:C10($l_año)
