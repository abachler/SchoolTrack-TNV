//%attributes = {}
  ...
  // Por: Alberto Bachler K.: 30-09-14, 11:45:19
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
C_BOOLEAN:C305($b_canceladoUsuario;$b_exito)
C_TEXT:C284($t_datafile;$t_estructura;$t_inicio;$t_logCompactacion;$t_NombreEstructura;$t_operacion;$t_refElemento;$t_refXML;$t_ruta;$t_termino)
...
$t_logCompactacion:=Get 4D folder:C485(Logs folder:K5:19)+$t_NombreEstructura+"_Verify_Log.xml"
...
If (Test path name:C476($t_logCompactacion)=Is a document:K24:1)
	...
	If (($t_datafile=Data file:C490) & ($t_operacion="Verify"))
		$y_inicio->:=$t_inicio
		$y_termino->:=$t_termino
		$y_exito->:=$b_exito
