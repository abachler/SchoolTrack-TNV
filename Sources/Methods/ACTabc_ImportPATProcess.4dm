//%attributes = {}
  ...
  //SET BLOB SIZE(xblob;0)
  //
  //CD_THERMOMETRE (1;0;"Procesando archivo PAT...")
  ...
  //If ($rut#"")
  //QUERY([Personas];[Personas]ACT_RUTTitular_TC=aRUT{$i};*)
  ...
  //<>aNumTarjetaRe{Size of array(<>aNumTarjetaRe)}:=aNumTarjeta{$i}
  ...
  //CD_THERMOMETRE (0;$i/Size of array(aRUT)*100;"Procesando archivo PAT...")
  //End for 
  //CD_THERMOMETRE (-1)
