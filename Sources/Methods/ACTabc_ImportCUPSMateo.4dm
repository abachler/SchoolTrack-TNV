...
While ($text#"")
	...
	$vd_date1:=DT_GetDateFromDayMonthYear (1;$vl_numCuota;Year of:C25(Current date:C33(*)))
	$vd_date2:=DT_GetDateFromDayMonthYear (DT_GetLastDay ($vl_numCuota;Year of:C25(Current date:C33(*)));$vl_numCuota;Year of:C25(Current date:C33(*)))
	...
	End if 
	ad_fechaVcto{Size of array:C274(ad_fechaVcto)}:=DT_GetDateFromDayMonthYear (1;$vl_numCuota;Year of:C25(Current date:C33(*)))
	RECEIVE PACKET:C104($ref;$text;$delimiter)
	$text:=_O_Win to Mac:C464($text)
End while 
