...
C_BOOLEAN:C305($b_error;$b_errorAlEliminar;$b_hecho)
C_LONGINT:C283($hl_lenguas;$hl_Paises;$i;$i_lenguas;$i_paises;$l_enArreglo;$l_final;$l_final1;$l_final2;$l_item)
C_LONGINT:C283($l_linea;$l_posicion;$l_proc;$l_unitID)
C_TEXT:C284($t_archivo;$t_bodyXML;$t_cierre;$t_codigo;$t_finMensaje;$t_footerXML;$t_headerXML;$t_inicioMensaje;$t_mensaje;$t_metodoOnErr)
C_TEXT:C284($t_ruta)
C_OBJECT:C1216($o_error)
...
If (False:C215)
	C_BOOLEAN:C305(4D_XLIFF_CreateFiles ;$0)
End if 
...
If (Not:C34(Is compiled mode:C492))
	...
	OB SET ARRAY:C1227($o_error;"mensaje";$at_mensajeError)
	OB SET ARRAY:C1227($o_error;"resource";$at_resourceError)
