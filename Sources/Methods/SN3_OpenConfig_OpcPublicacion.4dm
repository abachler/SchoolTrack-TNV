...
If (LICENCIA_esModuloAutorizado (1;SchoolNet))
	...
	If (USR_GetMethodAcces (Current method name:C684))
		WDW_OpenFormWindow (->[SN3_PublicationPrefs:161];"PublicationConfigurator";0;4;__ ("Configuración SchoolNet"))
		DIALOG:C40([SN3_PublicationPrefs:161];"PublicationConfigurator")
		CLOSE WINDOW:C154
