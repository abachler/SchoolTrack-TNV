...
While ($text#"")
	...
	AT_Insert (0;1;->aMonto;->aRUT;->aDescCodigo;->aCodAprobacion;->aNumTarjeta;->aNombre;->aCodFamilia;->aMontoMora;->aFechaPagos;->ad_fechaVcto)
	aMonto{Size of array:C274(aMonto)}:=Num:C11(Substring:C12($text;115;11))+Num:C11(Substring:C12($text;130;11))
	aRUT{Size of array:C274(aRUT)}:=ST_CleanSpecifiedChars (Substring:C12($text;34;35);" ")
	...
	$text:=_O_Win to Mac:C464($text)
End while 
AT_Delete (Size of array:C274(aMonto);1;->aMonto;->aRUT;->aDescCodigo;->aCodAprobacion;->aNumTarjeta;->aNombre;->aCodFamilia;->aMontoMora;->aFechaPagos;->ad_fechaVcto)
