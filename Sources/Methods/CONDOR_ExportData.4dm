...
C_BOOLEAN:C305($b_envioAut)
If (Count parameters:C259>=1)
	$b_envioAut:=$1
End if 

ARRAY LONGINT:C221($aProfMandados;0)
ARRAY LONGINT:C221($aAlusMandados;0)
...
If ((Records in table:C83([Personas:7])>0) | (Records in table:C83([Alumnos:2])>0) | (Records in table:C83([Profesores:4])>0))
	dbu_UpdateFamily 
	  //MONO: Revisamos la integridad de profesores que son relaciones familiares y vice versa
	dbu_RevisaIntegridad_PROF_RELFA 
	...
	If (Records in selection:C76([Personas:7])>0)
		...
		For ($indice;1;$size)
			...
			If ($vt_Name#"")
				...
				If ([Personas:7]RUT:6#"")  //20171222
					$hayProfe:=KRL_FindAndLoadRecordByIndex (->[Profesores:4]RUT:27;->[Personas:7]RUT:6)
					If ($hayProfe>No current record:K29:2)
						APPEND TO ARRAY:C911($aProfMandados;[Profesores:4]Numero:1)
						...
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"uuid_profesor";True:C214;[Profesores:4]Auto_UUID:41;False:C215;False:C215)
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"emails")
				...
				End if 
				If ([Personas:7]RUT:6#"")  //20171222
					If (KRL_FindAndLoadRecordByIndex (->[Alumnos:2]RUT:5;->[Personas:7]RUT:6)>No current record:K29:2)
						APPEND TO ARRAY:C911($aAlusMandados;[Alumnos:2]numero:1)
						...
						CONDOR_ExportSAXCreateNode ($refXMLDoc;"uuid_alumno";True:C214;[Alumnos:2]auto_uuid:72;False:C215;False:C215)
		...
		For ($indice;1;$size)
			If (Find in array:C230($aProfMandados;$arrayLong{$indice})=-1)
				...
				If ($vt_Name#"")
					...
					CONDOR_ExportSAXCreateNode ($refXMLDoc;"tipopersona";True:C214;"3";False:C215;False:C215)
					SAX CLOSE XML ELEMENT:C854($refXMLDoc)
					If ([Profesores:4]RUT:27#"")  //20171222
						If (KRL_FindAndLoadRecordByIndex (->[Alumnos:2]RUT:5;->[Profesores:4]RUT:27)>No current record:K29:2)
							APPEND TO ARRAY:C911($aAlusMandados;[Alumnos:2]numero:1)
							CONDOR_ExportSAXCreateNode ($refXMLDoc;"alumno")
							CONDOR_ExportSAXCreateNode ($refXMLDoc;"codigo_interno";True:C214;[Alumnos:2]Codigo_interno:6;True:C214;False:C215)
							CONDOR_ExportSAXCreateNode ($refXMLDoc;"curso";True:C214;[Alumnos:2]curso:20;True:C214;False:C215)
	...
	If (Records in selection:C76([Alumnos:2])>0)
		...
		For ($indice;1;$size)
			If (Find in array:C230($aAlusMandados;$arrayLong{$indice})=-1)
				APPEND TO ARRAY:C911($aAlusMandados;$arrayLong{$indice})
...
If (Records in selection:C76([Cursos:3])>0)
	...
	For ($indice;1;$size)
		...
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"letra";True:C214;[Cursos:3]Letra_del_curso:9;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"letraoficial";True:C214;[Cursos:3]Letra_Oficial_del_Curso:18;True:C214;False:C215)
...
For ($indice;1;$size)
	...
	While (Not:C34(End selection:C36([xxSTR_HistoricoNiveles:191])))
		...
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"year";True:C214;String:C10([xxSTR_HistoricoNiveles:191]Año:2);False:C215;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"nombre";True:C214;[xxSTR_HistoricoNiveles:191]NombreInterno:5;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"nombreoficial";True:C214;[xxSTR_HistoricoNiveles:191]NombreOficial:6;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"abreviatura";True:C214;[xxSTR_HistoricoNiveles:191]AbreviacionNivel_Interna:12;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"abreviatura_oficial";True:C214;[xxSTR_HistoricoNiveles:191]AbreviacionNivel_Oficial:13;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"EsNivelSubAnual";True:C214;String:C10(Num:C11([xxSTR_HistoricoNiveles:191]EsNivel_SubAnual:19));False:C215;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"ciclo";True:C214;[xxSTR_HistoricoNiveles:191]NombreDeCiclo:14;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"directorresponsable";True:C214;[xxSTR_HistoricoNiveles:191]DirectorResponsable:15;True:C214;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"numerodeperiodos";True:C214;String:C10([xxSTR_HistoricoNiveles:191]NumeroDePeriodos:16);False:C215;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"inicioagnoescolar";True:C214;SN3_MakeDateInmune2LocalFormat ([xxSTR_HistoricoNiveles:191]InicioAgnoEscolar:17);False:C215;False:C215)
		CONDOR_ExportSAXCreateNode ($refXMLDoc;"terminoagnoescolar";True:C214;SN3_MakeDateInmune2LocalFormat ([xxSTR_HistoricoNiveles:191]TerminoAgnoEscolar:18);False:C215;False:C215)
		SAX CLOSE XML ELEMENT:C854($refXMLDoc)
		NEXT RECORD:C51([xxSTR_HistoricoNiveles:191])
	End while 
	SAX CLOSE XML ELEMENT:C854($refXMLDoc)
...
$refXMLDoc:=CONDOR_ExportDataGenArchivo ("colegio";->$vt_FileName)
		...
		If ($err=0)
			...
			If ($err=0)
				...
				For ($x;1;Size of array:C274($aDocs))
					...
					If ($errorString="")
						LOG_RegisterEvt ("CONDOR_ExportData: Archivo "+$aDocs{$x}+" transferido con exito.")
					Else 
						LOG_RegisterEvt ("CONDOR_ExportData: Archivo "+$aDocs{$x}+" no transferido. "+$errorString)
					End if 
...
SN3_SetErrorHandler ("clear";$currentErrorHandler)
  ...
  //MONO 25-05-16 Preferencias para activar las marcas de las modificaciones a sincronizar
  //y conteo de ejecuciones de este método, solicitado por Edgardo
PREF_Set (0;"SYNC_RegistrarCambios";"True")

C_BLOB:C604($xBlob)
SET BLOB SIZE:C606($xBlob;0)
ARRAY TEXT:C222($at_usr;0)
ARRAY TEXT:C222($at_dts;0)
$xBlob:=PREF_fGetBlob (0;"CONDOR_ExportData_ejecuciones";$xBlob)
BLOB_Blob2Vars (->$xBlob;0;->$at_usr;->$at_dts)
APPEND TO ARRAY:C911($at_usr;<>tUSR_CurrentUser)
APPEND TO ARRAY:C911($at_dts;DTS_Get_GMT_TimeStamp (Current date:C33(*);Current time:C178(*)))
SET BLOB SIZE:C606($xBlob;0)
BLOB_Variables2Blob (->$xBlob;0;->$at_usr;->$at_dts)
PREF_SetBlob (0;"CONDOR_ExportData_ejecuciones";$xBlob)