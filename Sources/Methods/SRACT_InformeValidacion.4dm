...
If (ok=1)
	...
	Case of 
		...
		: (b3=1)
			...
			QUERY SELECTION:C341([ACT_Cargos:173];[ACT_Cargos:173]Fecha_de_generacion:4>=$iniDate;*)
			QUERY SELECTION:C341([ACT_Cargos:173];[ACT_Cargos:173]Fecha_de_generacion:4<=$endDate;*)
		: (b5=1)
			...
			QUERY SELECTION:C341([ACT_Cargos:173];[ACT_Cargos:173]Fecha_de_generacion:4<=$endDate;*)
		: (b6=1)
			QUERY SELECTION:C341([ACT_Cargos:173];[ACT_Cargos:173]Fecha_de_generacion:4>=vd_Fecha1;*)
			QUERY SELECTION:C341([ACT_Cargos:173];[ACT_Cargos:173]Fecha_de_generacion:4<=vd_Fecha2;*)
	End case 
