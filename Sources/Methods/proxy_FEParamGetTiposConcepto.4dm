...
$root:=DOM Create XML Ref:C861("FEParamGetTiposConcepto";$nameSpace)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposConcepto/Auth/Token")
DOM SET XML ELEMENT VALUE:C868($subElem;$1)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposConcepto/Auth/Sign")
DOM SET XML ELEMENT VALUE:C868($subElem;$2)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposConcepto/Auth/Cuit")
...
WEB SERVICE CALL:C778("https://wswhomo.afip.gov.ar/wsfev1/service.asmx";"http://ar.gov.afip.dif.FEV1/FEParamGetTiposConcepto";"FEParamGetTiposConcepto";"http://ar.gov.afip.dif.FEV1/";Web Service manual:K48:4)
...
If (OK=1)
	...
	$resSubElem:=DOM Find XML element:C864($resRoot;"/FEParamGetTiposConceptoResponse/FEParamGetTiposConceptoResult/Errors")
	...
	If (Size of array:C274($at_errores)=0)
		...
		$resSubElem1:=DOM Find XML element:C864($resRoot;"/FEParamGetTiposConceptoResponse/FEParamGetTiposConceptoResult/ResultGet")
		If ($resSubElem1#"0000000000000000")
			...
			For ($l_indice;1;DOM Count XML elements:C726($resSubElem1;"ConceptoTipo"))
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/ConceptoTipo["+String:C10($l_indice)+"]/Id")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret1)
				APPEND TO ARRAY:C911($al_id;$proxy_ret1)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/ConceptoTipo["+String:C10($l_indice)+"]/Desc")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret2)
				APPEND TO ARRAY:C911($at_desc;$proxy_ret2)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/ConceptoTipo["+String:C10($l_indice)+"]/FchDesde")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret3)
				APPEND TO ARRAY:C911($at_desde;$proxy_ret3)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/ConceptoTipo["+String:C10($l_indice)+"]/FchHasta")
