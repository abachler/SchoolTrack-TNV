//%attributes = {}
  //SN3_ParseConfigXML_OLD
  //MONO Ticket 209421: Utilizado solamente  para el método de actualización de la estructura de las opciones de publicación
...
If (BLOB size:C605($data->)>0)
	...
	cb_PublicarConductaYAsistencia:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/publicar"))
	cb_PublicarInasistencias:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/inasistencias/publicar"))
	cb_PublicarAtrasos:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/atrasos/publicar"))
	cb_PublicarAtrasosObs:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/atrasos/observaciones"))
	cb_PublicarAtrasosInter:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/atrasos/intersesiones"))
	...
	cb_PublicarPctAsistencia:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/porcasistencia/publicar"))
	cb_PublicarInaxAtraso:=Num:C11(DOM_GetValue ($xmlRef;"opciones/conducta/inasistencias/inasistenciaporatrasos"))
