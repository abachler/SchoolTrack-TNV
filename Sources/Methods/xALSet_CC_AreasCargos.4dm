...
$Error:=AL_SetArraysNam (xALP_Documentos;1;1;"aACT_CtasDCNoComprobante")
$Error:=AL_SetArraysNam (xALP_Documentos;2;1;"aACT_CtasDCFechaEmision")
$Error:=AL_SetArraysNam (xALP_Documentos;3;1;"aACT_CtasDCTotal")
$Error:=AL_SetArraysNam (xALP_Documentos;4;1;"aACT_CtasDCNeto")
$Error:=AL_SetArraysNam (xALP_Documentos;5;1;"aACT_CtasDCPagos")
$Error:=AL_SetArraysNam (xALP_Documentos;6;1;"aACT_CtasDCSaldo")
$Error:=AL_SetArraysNam (xALP_Documentos;7;1;"aACT_CtasDCID")
...
C_LONGINT:C283($Error)
  ...
  //specify arrays to display
$Error:=AL_SetArraysNam (xALP_DetalleDocumento;1;1;"aACT_CtasCFechaEmision")
$Error:=AL_SetArraysNam (xALP_DetalleDocumento;2;1;"aACT_CtasCGlosa")
$Error:=AL_SetArraysNam (xALP_DetalleDocumento;3;1;"aACT_CtasCMonto")
$Error:=AL_SetArraysNam (xALP_DetalleDocumento;4;1;"aACT_CtasCPagos")
...
AL_SetEntryCtls (xALP_DetalleDocumento;2;0)
  ...
  //column 3 settings
AL_SetCalcCall (xALP_DetalleDocumento;3;"xALP_CalcColumnACT_Trans")
AL_SetHeaders (xALP_DetalleDocumento;3;1;__ ("Monto"))
...
AL_SetEntryCtls (xALP_DetalleDocumento;3;0)
  ...
  //column 4 settings
AL_SetHeaders (xALP_DetalleDocumento;4;1;__ ("Pagos"))
