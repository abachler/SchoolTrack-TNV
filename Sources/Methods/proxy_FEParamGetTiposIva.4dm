...
$root:=DOM Create XML Ref:C861("FEParamGetTiposIva";$nameSpace)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposIva/Auth/Token")
DOM SET XML ELEMENT VALUE:C868($subElem;$1)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposIva/Auth/Sign")
DOM SET XML ELEMENT VALUE:C868($subElem;$2)

$subElem:=DOM Create XML element:C865($root;"/FEParamGetTiposIva/Auth/Cuit")
...
WEB SERVICE CALL:C778("https://wswhomo.afip.gov.ar/wsfev1/service.asmx";"http://ar.gov.afip.dif.FEV1/FEParamGetTiposIva";"FEParamGetTiposIva";"http://ar.gov.afip.dif.FEV1/";Web Service manual:K48:4)
...
If (OK=1)
	...
	$resSubElem:=DOM Find XML element:C864($resRoot;"/FEParamGetTiposIvaResponse/FEParamGetTiposIvaResult/Errors")
	...
	If (Size of array:C274($at_errores)=0)
		...
		$resSubElem1:=DOM Find XML element:C864($resRoot;"/FEParamGetTiposIvaResponse/FEParamGetTiposIvaResult/ResultGet")
		If ($resSubElem1#"0000000000000000")
			For ($l_indice;1;DOM Count XML elements:C726($resSubElem1;"IvaTipo"))
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/IvaTipo["+String:C10($l_indice)+"]/Id")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret1)
				APPEND TO ARRAY:C911($at_id;$proxy_ret1)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/IvaTipo["+String:C10($l_indice)+"]/Desc")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret2)
				APPEND TO ARRAY:C911($at_descripcion;$proxy_ret2)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/IvaTipo["+String:C10($l_indice)+"]/FchDesde")
				DOM GET XML ELEMENT VALUE:C731($resSubElem;$proxy_ret3)
				APPEND TO ARRAY:C911($at_desde;$proxy_ret3)
				
				$resSubElem:=DOM Find XML element:C864($resSubElem1;"/ResultGet/IvaTipo["+String:C10($l_indice)+"]/FchHasta")
		...
		$resSubElem:=DOM Find XML element:C864($resRoot;"/FEParamGetTiposIvaResponse/FEParamGetTiposIvaResult/Events")
		If ($resSubElem#"0000000000000000")
