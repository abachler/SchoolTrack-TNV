...
If (USR_GetMethodAcces (Current method name:C684))
	...
	Else 
		...
		READ ONLY:C145([ACT_Avisos_de_Cobranza:124])  //20170718 RCH
		READ ONLY:C145([ACT_Cargos:173])  //20170718 RCH
		...
		If (<>lACT_PagosCaja=0)
			  //el nombre del proceso ("Ingreso de Pagos") es utilizado en ACTcfg_LeeConfEnNuevoProc
			  //<>lACT_PagosCaja:=New process("ACTcc_RegistroPagosCaja";128*1024;"Ingreso de Pagos";$RNApdo;$RNCta;$RNTercero;vpXS_IconModule;vsBWR_CurrentModule)
			<>lACT_PagosCaja:=New process:C317("ACTcc_RegistroPagosCaja";Pila_256K;"Ingreso de Pagos";$RNApdo;$RNCta;$RNTercero;vpXS_IconModule;vsBWR_CurrentModule)  //ASM 20141007
		Else 
			BRING TO FRONT:C326(<>lACT_PagosCaja)
		End if 
	End if 
End if 