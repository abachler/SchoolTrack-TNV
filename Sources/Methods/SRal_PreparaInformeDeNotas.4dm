...
C_LONGINT:C283($rubOfst;$2;vPeriodo;$4;$allMothers;$estiloPropioEnHijas;$5;$tableNumber;$nextField)
C_POINTER:C301($crtPerPtr)
C_POINTER:C301($crtCtrlPtr)
C_TEXT:C284(vsPromedioSubEval_1;vsPromedioSubEval_2;vsPromedioSubEval_3;vsPromedioSubEval_4;vsPromedioSubEval_5;vsPromedioSubEval_6;vsPromedioSubEval_7;vsPromedioSubEval_8;vsPromedioSubEval_9;vsPromedioSubEval_10;vsPromedioSubEval_11;vsPromedioSubEval_12)


$event:=$1
Case of 
	: (Count parameters:C259=5)
		$estiloPropioEnHijas:=$5
		$allMothers:=$4
...
Case of 
	...
	: ($event="Cuerpo")
		...
		End case 
		If (vPeriodo=0)
			vPeriodo:=viSTR_Periodos_NumeroPeriodos
		End if 
		$periodo:=vPeriodo
		...
		Case of 
			: ($periodo=1)
				...
				vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual:202]P01_Maximo_Real:85
				vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual:202]P01_Minimo_Real:50
			...
			: ($periodo=2)
				...
				vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual:202]P02_Maximo_Real:86
				vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual:202]P02_Minimo_Real:51
			...
			: ($periodo=3)
				...
				vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual:202]P03_Maximo_Real:87
				vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual:202]P03_Minimo_Real:52
			...
			: ($periodo=4)
				...
				vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual:202]P04_Maximo_Real:88
				vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual:202]P04_Minimo_Real:53
			...
			: ($periodo=5)
				...
				vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual:202]P05_Maximo_Real:89
				vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual:202]P05_Minimo_Real:54
		...
		End case 
		  ...
		  //vs_MaxSubject_Color:="Red"
		  //Else 
		  //vs_MaxSubject_Color:="Blue"
		  //End if 
		  //If (vr_PorcentajesMinSubject<rPctMinimum)
		  //vs_MinSubject_Color:="Red"
		  //Else 
		  //vs_MinSubject_Color:="Blue"
		  //End if 
		  //If (vr_PorcentajesAvgSubject<rPctMinimum)
		  //vs_AvgSubject_Color:="Red"
		  //Else 
		  //vs_AvgSubject_Color:="Blue"
		  //End if 
		...
		For ($i;1;12)
			...
			End if 
			aSRpDefaultModePointers{$i}->:=EV2_Real_a_Literal (Field:C253($tableNumber;$nextField)->;iPrintMode)  //ASM cambio para mostrar la calificación, según configuración de estilo de evaluación
		...
		vs_IndicadorPresentacion:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]PeriodoActual_Present_Real:477;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorEXP:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]PeriodoActual_Present_Real:477;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedioPeriodo:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]PeriodoActual_Final_Real:487;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPresentacionP1:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P01_Presentacion_Real:102;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorEXP1:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P01_Control_Real:107;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedio1:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P01_Final_Real:112;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPresentacionP2:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P02_Presentacion_Real:177;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorEXP2:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P02_Control_Real:182;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedio2:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P02_Final_Real:187;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPresentacionP3:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P03_Presentacion_Real:252;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedio3:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P03_Final_Real:262;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPresentacionP4:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P04_Presentacion_Real:327;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorEXP4:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P04_Control_Real:332;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedio4:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P04_Final_Real:337;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPresentacionP5:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P05_Presentacion_Real:402;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorEXP5:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P05_Control_Real:407;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedio5:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]P05_Final_Real:412;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorPromedioFinal:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]Anual_Real:11;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorExamen:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]ExamenAnual_Real:16;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		vs_IndicadorFinal:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]EvaluacionFinal_Real:26;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		EVS_ReadStyleData ([xxSTR_Niveles:6]EvStyle_oficial:23)
		  ...
		  //If ([Alumnos_Calificaciones]EvaluacionFinalOficial_Real<rPctMinimum) -- DLC: esto dejaba el promedio general con el color de la ultima calificación listada en el informe
		...
		vs_IndicadorOficial:=_Evaluacion_a_Indicador ([Alumnos_Calificaciones:208]EvaluacionFinalOficial_Real:32;[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
		...
		iConversionTable:=0
		  ...
		  //vr_PorcentajesMaxSubject:=[Asignaturas_SintesisAnual]P01_Minimo_Real
		  //vr_PorcentajesMinSubject:=[Asignaturas_SintesisAnual]P01_Maximo_Real
		  //vr_PorcentajesAvgSubject:=[Asignaturas_SintesisAnual]P01_Promedio_Real
		...
		vs_EvaluacionAvgSubjectF:=[Asignaturas_SintesisAnual:202]PromedioOficial_Literal:24
		...
		Case of 
			: ($detail>0)
				C_LONGINT:C283($recnum_alu)
				$recnum_alu:=Record number:C243([Alumnos:2])
				SRal_ResizeSubEvalArrays (0)
				$size:=0
				$tableNumber:=Table:C252(->[Alumnos_Calificaciones:208])
				$nextFieldP1:=Field:C253(->[Alumnos_Calificaciones:208]P01_Eval01_Real:42)
				$nextFieldP2:=Field:C253(->[Alumnos_Calificaciones:208]P02_Eval01_Real:117)
				$nextFieldP3:=Field:C253(->[Alumnos_Calificaciones:208]P03_Eval01_Real:192)
				$nextFieldP4:=Field:C253(->[Alumnos_Calificaciones:208]P04_Eval01_Real:267)
				$nextFieldP5:=Field:C253(->[Alumnos_Calificaciones:208]P05_Eval01_Real:342)
				$estiloMadre:=KRL_GetNumericFieldData (->[Asignaturas:18]Numero:1;->[Alumnos_Calificaciones:208]ID_Asignatura:5;->[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
				...
				For ($parciales;1;Size of array:C274(alAS_EvalPropSourceID))
					If (abAS_EvalPropPrintDetail{$parciales})
						...
						Case of 
							...
							: (alAS_EvalPropSourceID{$parciales}>0)
								If ($estiloPropioEnHijas=1)
									$idHija:=alAS_EvalPropSourceID{$parciales}
									$estilo:=KRL_GetNumericFieldData (->[Asignaturas:18]Numero:1;->$idHija;->[Asignaturas:18]Numero_de_EstiloEvaluacion:39)
									EVS_initialize 
									EVS_ReadStyleData ($estilo)
								Else 
									$estilo:=0
								End if 
								GOTO RECORD:C242([Alumnos:2];$recnum_alu)
				...
				End for 
				  ...
				  //reestablezco el estilo de la asignatura principal en caso que las hijas usen otro estilo
				EVS_ReadStyleData ($estiloMadre)
		End case 
		...
		vs_ObservacionesPeriodoG:=[Alumnos_SintesisAnual:210]P00_Observaciones_Academicas:85
		  ...
		  //If (vs_PromedioG_Periodo=(Char(0)+"@"))
		  //vs_TextColorG_Periodo:="Red"
		  //vs_PromedioG_Periodo:=Substring(vs_PromedioG_Periodo;2)
		  //Else 
		  //vs_TextColorG_Periodo:="Blue"
		  //End if 
		  //
		  //If (vs_PromedioG_PS=(Char(0)+"@"))
		  //vs_TextColorG_PS:="Red"
		  //vs_PromedioG_PS:=Substring(vs_PromedioG_PS;2)
		  //Else 
