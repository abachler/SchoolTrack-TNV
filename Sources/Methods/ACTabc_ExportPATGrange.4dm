...
For ($i;1;Size of array:C274(aidsAvisos))
	...
	If ($linea=-1)
		AT_Insert (1;1;->aIndicador;->aMonto;->aNumTarjeta;->aNombre;->aRUT;->aCodPAT;->aVencTarjeta;->aidsPersonas;->aCodPATNum)
		...
		aCodPATNum{1}:=Num:C11([Personas:7]ACT_CodMandatoPAT:63)
	Else 
...
SORT ARRAY:C229(aCodPATNum;aCodPAT;aIndicador;aMonto;aNumTarjeta;aVencTarjeta;aNombre;aRUT;>)
...
AT_Initialize (->aIndicador;->aMonto;->aNumTarjeta;->aNombre;->aRUT;->aCodPAT;->aVencTarjeta;->aidsPersonas;->aidsAvisos;->aCodPATNum)