//%attributes = {}
  ...
  // Fecha y hora: 02/10/15, 16:37:49
  // ----------------------------------------------------
  // Método: STWA2_OWC_eliminaCastigo
  // Descripción
  // 
  //
  // Parámetros
...
$rn:=Num:C11(NV_GetValueFromPairedArrays ($y_ParameterNames;$y_ParameterValues;"rn"))
  //$jsonT:=JSON New 
$ob_raiz:=OB_Create 
KRL_GotoRecord (->[Alumnos_Castigos:9];$rn)
$alumnoNombre:=KRL_GetTextFieldData (->[Alumnos:2]numero:1;->[Alumnos_Castigos:9]Alumno_Numero:8;->[Alumnos:2]apellidos_y_nombres:40)
$fecha:=[Alumnos_Castigos:9]Fecha:9
If (KRL_DeleteRecord (->[Alumnos_Castigos:9];$rn)=1)
	Log_RegisterEvtSTW ("Eliminación de Castigo ("+String:C10($fecha;Internal date short special:K1:4)+") para "+$alumnoNombre;$userID)
