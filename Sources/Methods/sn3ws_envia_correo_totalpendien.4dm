//%attributes = {}
  // 
  // sn3ws_envia_correo_totalpendientes
...
WEB SERVICE SET PARAMETER:C777("totalpendientes";$3)

$vtWS_ErrorString:=SN3_CallWebService ("sn3ws_ActualizacionDatos_proceso.envia_correo_totalpendientes")
