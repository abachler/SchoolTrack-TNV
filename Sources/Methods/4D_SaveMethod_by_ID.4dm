//%attributes = {}
  // 4D_SaveMethod_by_ID()
  // Por: Alberto Bachler: 18/11/13, 17:16:08
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
$vt_MethodText:=Replace string:C233($vt_MethodText;"\r\r";"\r \r")  // Preserve blank lines by inserting a space on them
...
For ($vl_LineNr;1;Size of array:C274($at_Lines))
	...
	$t_texto:=BLOB to text:C555($vx_LineTokens;Mac Pascal string:K22:8)
