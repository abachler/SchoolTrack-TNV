...
For ($i;1;Size of array:C274($vat_ArrayValues))
	...
	Case of 
		: ($vt_TypeOfUse="Use_Normal")
			  //$vt_HeaderXML:=Replace string($vt_OpenTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+String($i))
			$vt_HeaderXML:=Replace string:C233($vt_OpenTag;"+";$vat_ArrayNamesTags{$i}+"_"+String:C10($i))
		: ($vt_TypeOfUse="Use_Atributes_1")
			  //$vt_HeaderXML:=Replace string($vt_OpenTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+"Dato")
			$vt_HeaderXML:=Replace string:C233($vt_OpenTag;"+";$vat_ArrayNamesTags{$i}+"_"+"Dato")
		: ($vt_TypeOfUse="Use_Atributes_2")
	...
	Case of 
		: ($vt_TypeOfUse="Use_Normal")
			  //$vt_FooterXML:=Replace string($vt_CloseTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+String($i))
			$vt_FooterXML:=Replace string:C233($vt_CloseTag;"+";$vat_ArrayNamesTags{$i}+"_"+String:C10($i))
		: ($vt_TypeOfUse="Use_Atributes_1")
			  //$vt_FooterXML:=Replace string($vt_CloseTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+"Dato")
			$vt_FooterXML:=Replace string:C233($vt_CloseTag;"+";$vat_ArrayNamesTags{$i}+"_"+"Dato")
		: ($vt_TypeOfUse="Use_Atributes_2")
			  //$vt_FooterXML:=Replace string($vt_CloseTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i}))
			$vt_FooterXML:=Replace string:C233($vt_CloseTag;"+";$vat_ArrayNamesTags{$i})
	End case 
