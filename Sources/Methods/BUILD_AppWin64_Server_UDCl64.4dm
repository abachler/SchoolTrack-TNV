...
Else 
	...
	If (SYS_IsMacintosh )
		$t_rutaScriptGeneracion:=Get 4D folder:C485(Database folder:K5:14)+"OEM Distribution"+Folder separator:K24:12+"BuildApp"+Folder separator:K24:12+"BuildAppMac64_v16.xml"
	Else 
		$t_rutaScriptGeneracion:=Get 4D folder:C485(Database folder:K5:14)+"OEM Distribution"+Folder separator:K24:12+"BuildApp"+Folder separator:K24:12+"BuildAppWinServer64_Client64Win.xml"
	End if 
	...
	Case of 
		...
		: (SYS_IsWindows )
			$t_rutaScriptGeneracion:=Get 4D folder:C485(Database folder:K5:14)+"Preferences"+Folder separator:K24:12+"BuildApp"+Folder separator:K24:12+"BuildAppWinServer64_Client64Win.xml"
	End case 
