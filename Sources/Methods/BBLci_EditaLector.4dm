//%attributes = {}
  // BBLci_EditaLector()
  // Por: Alberto Bachler K.: 28-01-14, 14:37:56
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
If (USR_checkRights ("M";yBWR_currentTable))
...
Else 
	$l_ignorar:=CD_Dlog (0;__ ("Usted no dispone de los derechos necesarios para editar los registros de la tabla:\r")+XSvs_nombreTablaLocal_puntero (yBWR_currentTable))
End if 
