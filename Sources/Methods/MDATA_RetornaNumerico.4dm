//%attributes = {}
  // Método: MDATA_RetornaNumerico
  //----------------------------------------------
  // Usuario (OS): Alberto Bachler
  // Fecha: 26/10/09, 10:36:53
  // ---------------------------------------------
  // Descripción: 
  // 
  // Parámetros:
...
If (Records in selection:C76([xxSTR_MetadatosLocales:141])=1)
	...
	$0:=KRL_GetNumericFieldData (->[MDATA_RegistrosDatosLocales:145]Llave:5;->$key;->[MDATA_RegistrosDatosLocales:145]Valor_Numerico:7)
End if 
