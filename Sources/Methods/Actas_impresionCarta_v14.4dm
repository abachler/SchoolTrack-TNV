//%attributes = {}
  ...
  // Por: Alberto Bachler K.: 03-05-14, 18:44:09
  //  ---------------------------------------------
  // 
  //
  //  ---------------------------------------------
...
If (Form event:C388=On Printing Detail:K2:18)
	...
	If (vi_PEStart>0)
		vPTextoPC:=vs_PCtext
		vPTextoPE:=vs_PEtext
		OBJECT MOVE:C664(*;"vPTextoPC";leftmarge+4;78;leftmarge+4+PCwidth+1;92;*)
		OBJECT MOVE:C664(*;"vPTextoPE";leftmarge+4+PCwidth;78;leftmarge+4+PCwidth+1+PEwidth;92;*)
		OBJECT MOVE:C664(*;"BorderTPC";leftmarge+4;78;leftmarge+4+PCwidth+1;92;*)
		OBJECT MOVE:C664(*;"BorderTPE";leftmarge+4+PCwidth;78;leftmarge+4+PCwidth+1+PEwidth;92;*)
	End if 
	...
	$height:=$height+6
	OBJECT MOVE:C664(*;"vPTexto1";4;91;6;91;*)
	OBJECT MOVE:C664(*;"vPTexto1";0;0;$widths{1}-1.25;$height)
	OBJECT MOVE:C664(*;"BorderT1";4;91;6;91;*)
