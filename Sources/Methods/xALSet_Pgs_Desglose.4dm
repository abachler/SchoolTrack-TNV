...
$error:=AL_SetArraysNam (xALP_DesglosePago;8;1;"aACT_ApdosDPAfectoPict")

  //column 1 settings
AL_SetHeaders (xALP_DesglosePago;1;1;__ ("Fecha"))
AL_SetWidths (xALP_DesglosePago;1;1;50)
...
AL_SetWidths (xALP_DesglosePago;2;1;50)
...
AL_SetWidths (xALP_DesglosePago;3;1;165)
...
AL_SetWidths (xALP_DesglosePago;4;1;75)
...
AL_SetWidths (xALP_DesglosePago;5;1;75)
...
AL_SetWidths (xALP_DesglosePago;6;1;75)
...
AL_SetWidths (xALP_DesglosePago;7;1;151)
...
AL_SetEntryCtls (xALP_DesglosePago;7;0)
  ...
  //column 8 settings
AL_SetHeaders (xALP_DesglosePago;8;1;__ ("Afecto a IVA"))
AL_SetWidths (xALP_DesglosePago;8;1;90)
AL_SetFormat (xALP_DesglosePago;8;"1";0;2;0;0)
AL_SetHdrStyle (xALP_DesglosePago;8;"Tahoma";9;1)
AL_SetFtrStyle (xALP_DesglosePago;8;"Tahoma";9;0)
AL_SetStyle (xALP_DesglosePago;8;"Tahoma";9;0)
AL_SetForeColor (xALP_DesglosePago;8;"Black";0;"Black";0;"Black";0)
AL_SetBackColor (xALP_DesglosePago;8;"White";0;"White";0;"White";0)
AL_SetEnterable (xALP_DesglosePago;8;1)
AL_SetEntryCtls (xALP_DesglosePago;8;0)
...
AL_SetRowOpts (xALP_DesglosePago;1;1;0;0;1;0)  //20091210 se permite multi seleccion de lineas
