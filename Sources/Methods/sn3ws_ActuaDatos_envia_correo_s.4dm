//%attributes = {}
  // 
  // sn3ws_ActuaDatos_envia_correo_seleccion
...
WEB SERVICE SET PARAMETER:C777("ids";$3)

$vtWS_ErrorString:=SN3_CallWebService ("sn3ws_ActualizacionDatos_proceso.envia_correo_avisoactiva_seleccion")
