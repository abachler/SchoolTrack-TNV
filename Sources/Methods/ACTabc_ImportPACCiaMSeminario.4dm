...
While ($text#"")
	...
	aMonto{Size of array:C274(aMonto)}:=Num:C11(Substring:C12($text;51;8))
	aRUT{Size of array:C274(aRUT)}:=ST_DeleteCharsLeft (Substring:C12($text;87;9);"0")
	aDescCodigo{Size of array:C274(aDescCodigo)}:=Substring:C12($text;98;28)
	If (aDescCodigo{Size of array:C274(aDescCodigo)}="CARGADO AL CLIENTE@")
	...
	QUERY:C277([Personas:7];[Personas:7]ACT_RUTTitutal_Cta:50=aRUT{Size of array:C274(aRUT)}+"@")
