...
For ($i;1;Size of array:C274($vat_ArrayValues))
	  //DOM Header
	  //$vt_HeaderXML:=Replace string($vt_OpenTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+"tag")
	$vt_HeaderXML:=Replace string:C233($vt_OpenTag;"+";$vat_ArrayNamesTags{$i}+"_"+"tag")
	$vt_DOMXML:=$vt_DOMXML+$vt_HeaderXML+$vt_CarriageReturn
	  //Data Item
	...
	$vt_DOMXML:=$vt_DOMXML+vt_ValueOfVarReceive+$vt_CarriageReturn
	  //DOM Footer
	  //$vt_FooterXML:=Replace string($vt_CloseTag;"+";XML_Gen_CleanXML ($vat_ArrayNamesTags{$i})+"_"+"tag")
	$vt_FooterXML:=Replace string:C233($vt_CloseTag;"+";$vat_ArrayNamesTags{$i}+"_"+"tag")
	$vt_DOMXML:=$vt_DOMXML+$vt_FooterXML+$vt_CarriageReturn
End for 
  //DOMXML Footer 
$vt_FooterXML:=Replace string:C233($vt_CloseTag;"+";XML_Gen_CleanXML ($vt_DOMXMLFooter))
