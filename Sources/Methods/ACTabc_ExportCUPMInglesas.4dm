...
aMontosArrayPtrs{1}->{Size of array:C274(aMontosArrayPtrs{1}->)}:=Sum:C1($FieldPtr->)
...
While (Not:C34(End selection:C36([ACT_Avisos_de_Cobranza:124])))
	...
	DIFFERENCE:C122("delApdo";"avisosASacar";"delApdo")
	FIRST RECORD:C50([ACT_Avisos_de_Cobranza:124])
	If ((Sum:C1($FieldPtr->)=$montoAnterior) & ([ACT_Avisos_de_Cobranza:124]Mes:6#$mesAnterior))
	...
	Else 
		If ([ACT_Avisos_de_Cobranza:124]Mes:6=$mesAnterior)
			aMontosArrayPtrs{$arrayAnterior}->{Size of array:C274(aMontosArrayPtrs{$arrayAnterior}->)}:=aMontosArrayPtrs{$arrayAnterior}->{Size of array:C274(aMontosArrayPtrs{$arrayAnterior}->)}+Sum:C1($FieldPtr->)
		...
		Else 
			...
			aMontosArrayPtrs{Size of array:C274(aMontosArrayPtrs)}->{Size of array:C274(aMontosArrayPtrs{Size of array:C274(aMontosArrayPtrs)}->)}:=Sum:C1($FieldPtr->)
			...
			Else 
				...
				Else 
					...
					Else 
						...
						aMontosArrayPtrs{$fileCounter}->{Size of array:C274(aMontosArrayPtrs{$fileCounter}->)}:=Sum:C1($FieldPtr->)
...
For ($i;1;Size of array:C274(aRNArrayPtrs))
	...
	For ($j;1;Size of array:C274(aRNArrayPtrs{$i}->))
		...
		$text:="005240"+Substring:C12([Personas:7]RUT:6+(" "*21);1;21)+(" "*9)+" "+(" "*60)+(" "*346)+ST_Uppercase (ST_RigthChars ("0000000000"+Substring:C12([Personas:7]RUT:6;1;Length:C16([Personas:7]RUT:6)-1);9))+ST_RigthChars ("0"+Substring:C12([Personas:7]RUT:6;Length:C16([Personas:7]RUT:6));1)+ST_LeftChars ([Personas:7]Apellidos_y_nombres:30+(" "*60);60)+ST_LeftChars ([Personas:7]Direccion:14+(" "*58);58)
